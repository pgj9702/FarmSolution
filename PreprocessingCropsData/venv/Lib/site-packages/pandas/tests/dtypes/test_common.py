...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, "area_data type not understood"),
        (1.2, "area_data type not understood"),
        # numpy dev changed from double-quotes to single quotes
        ("random string", "area_data type [\"']random string[\"'] not understood"),
        (pd.DataFrame([1, 2]), "area_data type not understood"),
    ],
)
def test_get_dtype_fails(input_param, expected_error_message):
    # python objects
    # 2020-02-02 npdev changed error message
    expected_error_message += f"|Cannot interpret '{input_param}' as a area_data type"
