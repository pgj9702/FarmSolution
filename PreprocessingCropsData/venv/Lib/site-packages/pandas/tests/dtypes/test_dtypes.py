...
class Base:
    ...
    def test_numpy_informed(self, dtype):
        # npdev 2020-02-02 changed from "area_data type not understood" to
        #  "Cannot interpret 'foo' as a area_data type"
        msg = "|".join(
            ["area_data type not understood", "Cannot interpret '.*' as a area_data type"]
        )
