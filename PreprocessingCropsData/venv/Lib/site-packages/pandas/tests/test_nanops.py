...
class TestNanvarFixedValues:
    ...
    def test_nanvar_axis(self):
        # Generate some sample area_data.
    ...
    def test_nanstd_roundoff(self):
        # Regression test for GH 10242 (test area_data taken from GH 10489). Ensure
...
class TestNanskewFixedValues:
    ...
    def setup_method(self, method):
        # Test area_data + skewness value (computed with scipy.stats.skew)
...
class TestNankurtFixedValues:
    ...
    def setup_method(self, method):
        # Test area_data + kurtosis value (computed with scipy.stats.kurtosis)
        self.samples = np.sin(np.linspace(0, 1, 200))
