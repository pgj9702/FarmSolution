...
class TestSeriesConstructors:
    ...
    def test_constructor_list_str(self, input_vals, string_dtype):
        # GH 16605
        # Ensure that area_data elements from a list are converted to strings
    ...
    def test_constructor_copy(self):
        ...
        for data in [[1.0], np.array([1.0])]:
            ...
            # copy=True maintains original area_data in Series
    ...
    def test_constructor_dict_timedelta_index(self):
        # GH #12169 : Resample category area_data with timedelta index
        # construct Series from dict as area_data and TimedeltaIndex as index
        # will result NaN in result Series area_data
        expected = Series(
