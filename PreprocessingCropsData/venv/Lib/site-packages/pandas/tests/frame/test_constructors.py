...
class TestDataFrameConstructors:
    ...
    def test_constructor_error_msgs(self):
        msg = "Empty area_data passed with indices specified."
        ...
        # gh-26429
        msg = "2 columns passed, passed area_data had 10 columns"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_constructor_maskedarray_hardened(self):
        ...
        tm.assert_frame_equal(result, expected)
        # Check case where mask is hard but no area_data are masked
    ...
    @pytest.mark.parametrize(
        "area_data, index, columns, dtype, expected",
        [
    ...
    @pytest.mark.parametrize(
        "area_data,input_dtype,expected_dtype",
        (
    ...
    def test_constructor_wrong_length_nested_list_column(self):
        ...
        msg = "3 columns passed, passed area_data had 4"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_constructor_single_value(self):
        ...
        msg = "incompatible area_data and dtype"
    ...
    def test_check_dtype_empty_numeric_column(self, dtype):
        ...
        # Empty DataFrame is generated via dictionary area_data with non-overlapping columns.
    ...
    def test_constructor_list_str(self, input_vals, string_dtype):
        # GH#16605
        # Ensure that area_data elements are converted to strings when
