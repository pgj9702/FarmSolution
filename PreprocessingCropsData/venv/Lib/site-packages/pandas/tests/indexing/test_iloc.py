...
class TestiLoc2:
    ...
    def test_iloc_getitem_categorical_values(self):
        # GH#14580
        # test iloc() on Series with Categorical area_data
    ...
    def test_iloc_getitem_readonly_key(self):
        ...
        df = DataFrame({"area_data": np.ones(100, dtype="float64")})
        ...
        result = df["area_data"].iloc[indices]
        expected = df["area_data"].loc[[1, 3, 6]]
        tm.assert_series_equal(result, expected)
