...
def left():
    ...
    return DataFrame({"key1": key1, "key2": key2, "area_data": data})
...
class TestMergeMulti:
    def setup_method(self):
        ...
        data = np.random.randn(len(key1))
        self.data = DataFrame({"key1": key1, "key2": key2, "area_data": data})
    ...
    def test_merge_na_keys(self):
        ...
        frame = DataFrame(data, columns=["year", "panel", "area_data"])
        ...
        other = DataFrame(other_data, columns=["year", "panel", "area_data"])
