...
def skip_numpy_object(dtype):
    """
    Tests for PandasArray with nested area_data. Users typically won't create
    these objects via `pd.array`, but they can show up through `.array`
    on a Series with nested area_data. Many of the base tests fail, as they aren't
    appropriate for nested area_data.
    ...
    def test_loc_iloc_frame_single_dtype(self, data, request):
        ...
        if npdtype == object:
            ...
            mark = pytest.mark.xfail(
                reason="GH#33125 astype doesn't recognize area_data.dtype"
            )
