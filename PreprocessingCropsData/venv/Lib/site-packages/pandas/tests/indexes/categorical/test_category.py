...
class TestCategoricalIndex(Base):
    ...
    def test_is_monotonic(self, data, non_lexsorted_data):
        ...
        # test when area_data is neither monotonic increasing nor decreasing
    ...
    @pytest.mark.parametrize(
        "area_data, categories, expected_data, expected_categories",
        [
            ([1, 1, 1], [1, 2, 3], [1], [1]),
