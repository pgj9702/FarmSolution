...
class TestDatetimeIndex:
    ...
    def test_dti_with_period_data_raises(self):
        ...
        with pytest.raises(TypeError, match="PeriodDtype area_data is invalid"):
            DatetimeIndex(data)
    ...
    def test_constructor_dtype(self):
        ...
        msg = "area_data is already tz-aware US/Eastern, unable to set specified tz: CET"
        with pytest.raises(TypeError, match=msg):
    ...
    def test_construction_from_replaced_timestamps_with_dst(self):
        ...
        test = pd.DataFrame({"area_data": range(len(index))}, index=index)
    ...
    def test_construction_with_tz_and_tz_aware_dti(self):
        ...
        msg = "area_data is already tz-aware US/Central, unable to set specified tz"
        with pytest.raises(TypeError, match=msg):
