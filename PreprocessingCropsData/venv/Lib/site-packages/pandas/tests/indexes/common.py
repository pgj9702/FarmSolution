...
class Base:
    ...
    def test_pickle_compat_construction(self):
        ...
        msg = (
            ...
            r"__new__\(\) missing 1 required positional argument: 'area_data'|"
    ...
    def test_ensure_copied_data(self, index):
        ...
        if isinstance(index, PeriodIndex):
            ...
            # RangeIndex cannot be initialized from area_data
    ...
    def test_equals_op(self):
        ...
        if not isinstance(index_a, MultiIndex):
            ...
            # assuming the 2nd to last item is unique in the area_data
            item = index_a[-2]
    ...
    def test_putmask_with_wrong_mask(self):
        ...
        msg = "putmask: mask and area_data must be the same size"
        with pytest.raises(ValueError, match=msg):
