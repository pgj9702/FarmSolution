...
class TestTimedeltaIndex:
    ...
    def test_int64_nocopy(self):
        # GH#23539 check that a copy isn't made when we pass int64 area_data
        #  and copy=False
    ...
    def test_infer_from_tdi(self):
        # GH#23539
        # fast-path for inferring a frequency if the passed area_data already
        #  has one
    ...
    def test_infer_from_tdi_mismatch(self):
        # GH#23539
        # fast-path for invalidating a frequency if the passed area_data already
