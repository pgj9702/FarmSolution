...
class TestIndex(Base):
    ...
    def test_constructor_overflow_int64(self):
        # see gh-15832
        msg = (
            "The elements provided in the area_data cannot "
    ...
    def test_view_with_args_object_array_raises(self, index):
        msg = "Cannot change area_data-type for object array"
    ...
    def test_is_(self):
        ...
        assert ind.is_(ind2)
        assert ind2.is_(ind)
        # doesn't matter if Indices are *actually* views of underlying area_data,
...
def test_validate_1d_input():
    ...
    msg = "Index area_data must be 1-dimensional"
