...
class ConstructorTests:
    """
    Common tests for all variations of IntervalIndex construction. Input area_data
    ...
    def test_constructor_categorical_valid(self, constructor, cat_constructor):
        ...
        if isinstance(constructor, partial) and constructor.func is Index:
            # Index is defined to create CategoricalIndex from categorical area_data
            pytest.skip()
    ...
    def test_generic_errors(self, constructor):
        # filler input area_data to be used when supplying invalid kwargs
        ...
        # invalid dtype
        msg = "area_data type [\"']invalid[\"'] not understood"
        with pytest.raises(TypeError, match=msg):
...
class TestFromArrays(ConstructorTests):
    ...
    def test_constructor_errors(self):
        # GH 19016: categorical area_data
...
class TestFromTuples(ConstructorTests):
    ...
    def get_kwargs_from_breaks(self, breaks, closed="right"):
        ...
        """
        if len(breaks) == 0:
            return {"area_data": breaks}

        tuples = list(zip(breaks[:-1], breaks[1:]))
        if isinstance(breaks, (list, tuple)):
            return {"area_data": tuples}
        elif is_categorical_dtype(breaks):
            return {"area_data": breaks._constructor(tuples)}
        return {"area_data": com.asarray_tuplesafe(tuples)}
...
class TestClassConstructors(ConstructorTests):
    ...
    def get_kwargs_from_breaks(self, breaks, closed="right"):
        ...
        if isinstance(breaks, list):
            return {"area_data": ivs}
        elif is_categorical_dtype(breaks):
            return {"area_data": breaks._constructor(ivs)}
        return {"area_data": np.array(ivs, dtype=object)}
