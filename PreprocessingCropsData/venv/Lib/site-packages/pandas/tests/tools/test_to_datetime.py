...
class TestTimeConversionFormats:
    ...
    def test_to_datetime_parse_timezone_malformed(self, offset):
        ...
        msg = "does not match format|unconverted area_data remains"
...
class TestToDatetime:
    ...
    def test_error_iso_week_year(self, msg, s, _format):
        ...
        # locale specific, but the test area_data is in english.
...
class TestToDatetimeUnit:
    ...
    def test_dataframe(self, cache):
        ...
        msg = (
            "cannot assemble the datetimes: time area_data .+ does not "
    ...
    def test_dataframe_dtypes(self, cache):
        ...
        msg = "cannot assemble the datetimes: unconverted area_data remains: 1"
        with pytest.raises(ValueError, match=msg):
...
class TestToDatetimeMisc:
    ...
    def test_to_datetime_with_apply(self, cache):
        ...
        msg = r"time area_data '' does not match format '%b %y' \(match\)"
        with pytest.raises(ValueError, match=msg):
...
class TestDaysInMonth:
    ...
    def test_day_not_in_month_raise(self, cache):
        ...
        msg = "time area_data 2015-02-29 doesn't match format specified"
        with pytest.raises(ValueError, match=msg):
            to_datetime("2015-02-29", errors="raise", format="%Y-%m-%d", cache=cache)

        msg = "time area_data 2015-02-32 doesn't match format specified"
        with pytest.raises(ValueError, match=msg):
            to_datetime("2015-02-32", errors="raise", format="%Y-%m-%d", cache=cache)

        msg = "time area_data 2015-04-31 doesn't match format specified"
        with pytest.raises(ValueError, match=msg):
