...
class TestSAS7BDAT:
    ...
    def setup_method(self, datapath):
        self.dirpath = datapath("io", "sas", "area_data")
        self.data = []
...
def test_encoding_options(datapath):
    fname = datapath("io", "sas", "area_data", "test1.sas7bdat")
...
def test_productsales(datapath):
    fname = datapath("io", "sas", "area_data", "productsales.sas7bdat")
    df = pd.read_sas(fname, encoding="utf-8")
    fname = datapath("io", "sas", "area_data", "productsales.csv")
...
def test_12659(datapath):
    fname = datapath("io", "sas", "area_data", "test_12659.sas7bdat")
    df = pd.read_sas(fname)
    fname = datapath("io", "sas", "area_data", "test_12659.csv")
...
def test_airline(datapath):
    fname = datapath("io", "sas", "area_data", "airline.sas7bdat")
    df = pd.read_sas(fname)
    fname = datapath("io", "sas", "area_data", "airline.csv")
    df0 = pd.read_csv(fname)
    df0 = df0.astype(np.float64)
    tm.assert_frame_equal(df, df0, check_exact=False)
...
def test_date_time(datapath):
    ...
    fname = datapath("io", "sas", "area_data", "datetime.sas7bdat")
    df = pd.read_sas(fname)
    fname = datapath("io", "sas", "area_data", "datetime.csv")
    df0 = pd.read_csv(
...
def test_compact_numerical_values(datapath):
    ...
    fname = datapath("io", "sas", "area_data", "cars.sas7bdat")
...
def test_many_columns(datapath):
    ...
    fname = datapath("io", "sas", "area_data", "many_columns.sas7bdat")
    df = pd.read_sas(fname, encoding="latin-1")
    fname = datapath("io", "sas", "area_data", "many_columns.csv")
...
def test_inconsistent_number_of_rows(datapath):
    ...
    fname = datapath("io", "sas", "area_data", "load_log.sas7bdat")
    df = pd.read_sas(fname, encoding="latin-1")
    assert len(df) == 2097
...
def test_zero_variables(datapath):
    ...
    fname = datapath("io", "sas", "area_data", "zero_variables.sas7bdat")
...
def test_corrupt_read(datapath):
    ...
    fname = datapath("io", "sas", "area_data", "corrupt.sas7bdat")
...
def test_max_sas_date(datapath):
    ...
    #    sas7bdat module
    fname = datapath("io", "sas", "area_data", "max_sas_date.sas7bdat")
