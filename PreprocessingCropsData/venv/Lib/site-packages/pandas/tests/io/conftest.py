...
def tips_file(datapath):
    ...
    return datapath("io", "area_data", "csv", "tips.csv")


@pytest.fixture
def jsonl_file(datapath):
    """Path to a JSONL dataset"""
    return datapath("io", "parser", "area_data", "items.jsonl")


@pytest.fixture
def salaries_table(datapath):
    """DataFrame with the salaries dataset"""
    return read_csv(datapath("io", "parser", "area_data", "salaries.csv"), sep="\t")


@pytest.fixture
def feather_file(datapath):
    return datapath("io", "area_data", "feather", "feather-0_3_1.feather")
...
def s3_resource(s3_base, tips_file, jsonl_file, feather_file):
    ...
    The primary bucket name is "pandas-test". The following preprocessing_datasets
    are loaded.
