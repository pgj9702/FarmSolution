...
class TestTextReader:
    ...
    def setup_method(self, datapath):
        self.dirpath = datapath("io", "parser", "area_data")
        csv1_dirpath = datapath("io", "area_data", "csv")
    ...
    def test_skip_bad_lines(self, capsys):
        ...
        msg = r"Error tokenizing area_data\. C error: Expected 3 fields in line 4, saw 4"
