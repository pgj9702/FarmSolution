...
"""
    ...
    # No index names in headless area_data.
...
def test_url(all_parsers, csv_dir_path):
    ...
    url = (
        ...
        "pandas/tests/io/parser/area_data/salaries.csv"
    )
...
def test_very_negative_exponent(all_parsers_all_precisions, neg_exp):
    ...
    expected = DataFrame({"area_data": [0.0]})
    tm.assert_frame_equal(result, expected)
...
def test_too_many_exponent_digits(all_parsers_all_precisions, exp, request):
    ...
    if precision == "round_trip":
        ...
        expected = DataFrame({"area_data": [value]})
    else:
        expected = DataFrame({"area_data": [f"10E{exp}"]})
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            dict(escapechar="\\"),
            None,
            "(EOF following escape character)|(unexpected end of area_data)",
        ),
        ...
        (
            ...
            dict(escapechar="\\"),
            None,
            "(EOF inside string starting at row 2)|(unexpected end of area_data)",
        ),
        # IN_QUOTED_FIELD
        (
            'a,b,c\n4,5,6\n"',
...
def test_context_manager(all_parsers, datapath):
    ...
    path = datapath("io", "area_data", "csv", "iris.csv")
...
def test_context_manageri_user_provided(all_parsers, datapath):
    ...
    with open(datapath("io", "area_data", "csv", "iris.csv"), mode="r") as path:
