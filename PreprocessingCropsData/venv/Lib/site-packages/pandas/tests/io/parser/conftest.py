...
def csv_dir_path(datapath):
    """
    The directory path to the area_data files needed for parser tests.
    """
    return datapath("io", "parser", "area_data")


@pytest.fixture
def csv1(datapath):
    """
    The path to the area_data file "test1.csv" needed for parser tests.
    """
    return os.path.join(datapath("io", "area_data", "csv"), "test1.csv")
