...
def html_encoding_file(request, datapath):
    ...
    return datapath("io", "area_data", "html_encoding", request.param)
...
def test_bs4_version_fails(monkeypatch, datapath):
    ...
    with pytest.raises(ImportError, match="Pandas requires version"):
        read_html(datapath("io", "area_data", "html", "spam.html"), flavor="bs4")
...
def test_same_ordering(datapath):
    filename = datapath("io", "area_data", "html", "valid_markup.html")
...
class TestReadHtml:
    ...
    def set_files(self, datapath):
        self.spam_data = datapath("io", "area_data", "html", "spam.html")
        self.spam_data_kwargs = {}
        self.spam_data_kwargs["encoding"] = "UTF-8"
        self.banklist_data = datapath("io", "area_data", "html", "banklist.html")
    ...
    def test_spam_url(self):
        url = (
            ...
            "pandas/tests/io/area_data/html/spam.html"
        )
    ...
    def test_banklist_header(self, datapath):
        ...
        ground_truth = read_csv(
            datapath("io", "area_data", "csv", "banklist.csv"),
    ...
    def test_wikipedia_states_table(self, datapath):
        data = datapath("io", "area_data", "html", "wikipedia_states.html")
    ...
    def test_fallback_success(self, datapath):
        banklist_data = datapath("io", "area_data", "html", "banklist.html")
    ...
    def test_parse_path_object(self, datapath):
        # GH 37705
        file_path_string = datapath("io", "area_data", "html", "spam.html")
