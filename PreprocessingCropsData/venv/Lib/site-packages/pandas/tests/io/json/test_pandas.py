...
class TestPandasContainer:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                '"index":["1","2","3"],'
                '"area_data":[[1.0,"1"],[2.0,"2"],[null,"3"]]}',
                "3 columns passed, passed area_data had 2 columns",
                "split",
            ),
            # bad key
            (
    ...
    def test_v12_compat(self, datapath):
        ...
        dirpath = datapath("io", "json", "area_data")
...
\\[right\\]: RangeIndex\\(start=0, stop=2, step=1\\)"""
    ...
    def test_to_jsonl(self):
        ...
        # GH15096: escaped characters in columns and area_data
        df = DataFrame([["foo\\", "bar"], ['foo"', "bar"]], columns=["a\\", "b"])
        result = df.to_json(orient="records", lines=True)
        expected = '{"a\\\\":"foo\\\\","b":"bar"}\n{"a\\\\":"foo\\"","b":"bar"}\n'
        assert result == expected
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Series([1, 2, 3], name="A"), {"name": "A", "area_data": [1, 2, 3]}),
            (
                Series([1, 2, 3], name="A").rename_axis("foo"),
                {"name": "A", "area_data": [1, 2, 3]},
            ),
            (
                Series([1, 2], name="A", index=[["a", "b"], ["c", "d"]]),
                {"name": "A", "area_data": [1, 2]},
            ),
        ],
    )
    ...
    def test_index_false_to_json_table(self, data):
        ...
        expected = {
            ...
            "area_data": DataFrame(data).to_dict(orient="records"),
        }
