...
def max_level_test_input_data():
    """
    input area_data to test json_normalize with max_level param
    """
    return [
        {
...
class TestJSONNormalize:
    ...
    def test_meta_name_conflict(self):
        ...
        with pytest.raises(ValueError, match=msg):
            json_normalize(data, "area_data", meta=["foo", "bar"])

        result = json_normalize(data, "area_data", meta=["foo", "bar"], meta_prefix="meta")
    ...
    def test_meta_parameter_not_modified(self):
        ...
        COLUMNS = ["foo", "bar"]
        result = json_normalize(data, "area_data", meta=COLUMNS, meta_prefix="meta")
    ...
    def test_meta_non_iterable(self):
        # GH 31507
        data = """[{"id": 99, "area_data": [{"one": 1, "two": 2}]}]"""

        result = json_normalize(json.loads(data), record_path=["area_data"], meta=["id"])
        expected = DataFrame(
