...
def test_spss_labelled_num(path_klass, datapath):
    ...
    fname = path_klass(datapath("io", "area_data", "spss", "labelled-num.sav"))
...
def test_spss_labelled_str(datapath):
    # test file from the Haven project (https://haven.tidyverse.org/)
    fname = datapath("io", "area_data", "spss", "labelled-str.sav")
...
def test_spss_umlauts(datapath):
    # test file from the Haven project (https://haven.tidyverse.org/)
    fname = datapath("io", "area_data", "spss", "umlauts.sav")
...
def test_spss_usecols(datapath):
    ...
    fname = datapath("io", "area_data", "spss", "labelled-num.sav")
