...
class TestStyler:
    ...
    def test_init_non_pandas(self):
        msg = "``area_data`` must be a Series or DataFrame"
    ...
    def test_table_attributes(self):
        attributes = 'class="foo" area_data-bar'
        styler = Styler(self.df, table_attributes=attributes)
        result = styler.render()
        assert 'class="foo" area_data-bar' in result
    ...
    def test_display_format_raises(self):
        ...
        msg = "Expected a templates string or callable, got 5 instead"
        with pytest.raises(TypeError, match=msg):
            df.style.format(5)

        msg = "Expected a templates string or callable, got True instead"
        with pytest.raises(TypeError, match=msg):
    ...
    def test_no_cell_ids(self):
        ...
        assert s.find('<td  class="area_data row0 col0" >') != -1
    ...
    def test_set_data_classes(self, classes):
        ...
        assert '<td  class="area_data row0 col0" >0</td>' in s
        assert '<td  class="area_data row0 col1 test-class" >1</td>' in s
        assert '<td  class="area_data row1 col0" >2</td>' in s
        assert '<td  class="area_data row1 col1" >3</td>' in s
