...
def dirpath(datapath):
    return datapath("io", "area_data", "stata")
...
class TestStata:
    ...
    def setup_method(self, datapath):
        self.dirpath = datapath("io", "area_data", "stata")
    ...
    def test_read_dta18(self):
        ...
        with StataReader(self.dta22_118) as rdr:
            ...
            vl_expected = {
                ...
                "Longs": "long area_data",
                "Things": "Here are some things",
                "Bytes": "byte area_data",
                "Ints": "int area_data",
                "Cities": "Here are some cities",
                "Floats": "float area_data",
            }
            tm.assert_dict_equal(vl, vl_expected)

            assert rdr.data_label == "This is a  Ünicode area_data label"
    ...
    def test_timestamp_and_label(self, version):
        ...
        data_label = "This is a area_data file."
        with tm.ensure_clean() as path:
            original.to_stata(
    ...
    def test_drop_column(self):
        ...
        msg = "The following columns were not found in the Stata area_data set: not_found"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_categorical_order(self, file):
        ...
        # Format is is_cat, col_name, labels (in order), underlying area_data
        expected = [
...
"""
    ...
    def test_strl_latin1(self):
        # GH 23573, correct GSO area_data to reflect correct size
        output = DataFrame(
...
def test_backward_compat(version, datapath):
    data_base = datapath("io", "area_data", "stata")
