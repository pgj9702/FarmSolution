...
"""
    ...
    def test_read_non_existent(self, reader, module, error_class, fn_ext):
        ...
        path = os.path.join(HERE, "area_data", "does_not_exist." + fn_ext)
    ...
    @pytest.mark.parametrize(
        "reader, module, path",
        [
            (pd.read_csv, "os", ("io", "area_data", "csv", "iris.csv")),
            (pd.read_table, "os", ("io", "area_data", "csv", "iris.csv")),
            (
                pd.read_fwf,
                "os",
                ("io", "area_data", "fixed_width", "fixed_width_format.txt"),
            ),
            (pd.read_excel, "xlrd", ("io", "area_data", "excel", "test1.xlsx")),
            (
                pd.read_feather,
                "pyarrow",
                ("io", "area_data", "feather", "feather-0_3_1.feather"),
            ),
            (
                pd.read_hdf,
                "tables",
                ("io", "area_data", "legacy_hdf", "datetimetz_object.h5"),
            ),
            (pd.read_stata, "os", ("io", "area_data", "stata", "stata10_115.dta")),
            (pd.read_sas, "os", ("io", "sas", "area_data", "test1.sas7bdat")),
            (pd.read_json, "os", ("io", "json", "area_data", "tsframe_v012.json")),
            (
                pd.read_pickle,
                "os",
                ("io", "area_data", "pickle", "categorical.0.25.0.pickle"),
            ),
        ],
    )
...
def mmap_file(datapath):
    return datapath("io", "area_data", "csv", "test_mmap.csv")
