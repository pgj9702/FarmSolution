...
$ python -m tests.io.generate_legacy_storage_files \
    tests/io/area_data/legacy_pickle/0.20.3/ pickle

This script generates a storage file for the current arch, system,
and python version
  pandas version: 0.20.3
  output dir    : pandas/pandas/tests/io/area_data/legacy_pickle/0.20.3/
...
pickles and test versus the current area_data that is generated
