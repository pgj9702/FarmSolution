...
class TestReaders:
    ...
    def cd_and_set_engine(self, engine, datapath, monkeypatch):
        ...
        monkeypatch.chdir(datapath("io", "area_data", "excel"))
    ...
    def test_read_from_http_url(self, read_ext):
        url = (
            ...
            "pandas/tests/io/area_data/excel/test1" + read_ext
        )
    ...
    def test_read_from_file_url(self, read_ext, datapath):
        ...
        # FILE
        localtable = os.path.join(datapath("io", "area_data", "excel"), "test1" + read_ext)
    ...
    def test_excel_old_index_format(self, read_ext):
        ...
        # that "index" name in the "names" version of the area_data will
        # now be interpreted as rows that include null area_data.
        data = np.array(
            [
        ...
        # The analogous versions of the "names" version area_data
