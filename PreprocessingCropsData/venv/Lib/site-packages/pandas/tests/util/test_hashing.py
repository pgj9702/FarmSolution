...
def test_hash_pandas_empty_object(obj, index):
    ...
    # or without the index as the area_data is empty.
    _check_equal(obj, index=index)
...
def test_hash_keys():
    ...
    # different hashes for the same area_data.
    #
