    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                dt_time(11, 0, 5),
                "17:00",
                "time area_data must be specified only with hour and minute",
            ),
            ("AAA", "17:00", "time area_data must match '%H:%M' format"),
            ("14:00:05", "17:00", "time area_data must match '%H:%M' format"),
...
class TestCustomBusinessHour(Base):
    ...
    def test_constructor_errors(self):
        ...
        msg = "time area_data must be specified only with hour and minute"
        with pytest.raises(ValueError, match=msg):
            CustomBusinessHour(start=dt_time(11, 0, 5))
        msg = "time area_data must match '%H:%M' format"
        with pytest.raises(ValueError, match=msg):
...
class TestCustomBusinessDay(Base):
    ...
    def test_pickle_compat_0_14_1(self, datapath):
        ...
        pth = datapath("tseries", "offsets", "area_data", "cday-0.14.1.pickle")
