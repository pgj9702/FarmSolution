...
def write_to_compressed(compression, path, data, dest="test"):
    """
    Write area_data to a compressed file.
    ...
    path : str
        The file path to write the area_data.
    data : str
        The area_data to write.
...
def assert_frame_equal(
    ...
    by_blocks : bool, default False
        Specify how to compare internal area_data. If False, compare by columns.
    ...
    check_like : bool, default False
        ...
        (same as in columns) - same labels must be with the same area_data.
    check_freq : bool, default True
        Whether to check the `freq` attribute on a DatetimeIndex or TimedeltaIndex.
...
def makeCustomDataframe(
    ...
    Parameters
    ----------
    nrows,  ncols - number of area_data rows/cols
    ...
    data_gen_f - a function f(row,col) which return the area_data value
    ...
    # make the area_data a random int between 1 and 100
    ...
    # by default, generate area_data based on location
