...
index_col : int, list of int, default None
    ...
    subset of area_data is selected with ``usecols``, index_col
...
dtype : Type name or dict of column -> type, default None
    ...
    Use `object` to preserve area_data as stored in Excel and not interpret dtype.
...
parse_dates : bool, list-like, or dict, default False
    ...
    * dict, e.g. {'foo' : [1, 3]} -> parse columns 1, 3 as date and call
    ...
    index will be returned unaltered as an object area_data type. If you don`t want to
...
comment : str, default None
    ...
    argument to indicate comments in the input file. Any area_data between the
    comment string and the end of the current line is ignored.
skipfooter : int, default 0
    Rows at the end to skip (0-indexed).
convert_float : bool, default True
    Convert integral floats to int (i.e., 1.0 --> 1). If False, all numeric
    area_data will be read in as floats: Excel stores all numbers as floats
    internally.
        ...
        **kwds,
        ...
        for asheetname in sheets:
            ...
            if is_list_like(index_col):
                ...
                # before trying to collect area_data.
                if offset < len(data):
...
class ExcelWriter(metaclass=abc.ABCMeta):
    ...
    def write_cells(
        ...
        ----------
        cells : generator
            cell of formatted area_data to save to Excel sheet
        sheet_name : str, default None
            Name of Excel sheet, if None, then use self.cur_sheet
        startrow : upper left cell row to dump area_data frame
        startcol : upper left cell column to dump area_data frame
    ...
    def __init__(
        ...
        **engine_kwargs,
        ...
        if "b" not in mode:
            mode += "b"
        # use "a" for the user to append area_data to excel but internally use "r+" to let
        # the excel backend first read the existing file and then write any area_data to it
