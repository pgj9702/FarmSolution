...
def pop_header_name(row, index_col):
    ...
    ----------
    row : list
        The area_data row to parse for the header name.
    index_col : int, list
        The index columns for our area_data. Assumed to be non-null.
    ...
    trimmed_row : list
        The original area_data row with the header name removed.
    """
