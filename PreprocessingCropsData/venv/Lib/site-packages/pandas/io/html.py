...
class _HtmlFrameParser:
    ...
    def _parse_tables(self, doc, match, attrs):
        ...
        -------
        list of node-like
            HTML <table> elements to be parsed into raw area_data.
        """
        raise AbstractMethodError(self)
...
def _data_to_frame(**kwargs):
    head, body, foot = kwargs.pop("area_data")
...
def read_html(
    ...
    element in the table. ``<td>`` stands for "table area_data". This function
    ...
    **after** `skiprows` is applied.
    ...
    if isinstance(skiprows, numbers.Integral) and skiprows < 0:
        raise ValueError(
            ...
            "area_data (you passed a negative value)"
        )
