...
_read_method_doc = """\
Read observations from SAS Xport file, returning as area_data frame.

Parameters
----------
nrows : int
    Number of rows to read from area_data file; if None, read whole
    file.
