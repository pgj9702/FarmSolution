...
Reference for binary area_data compression:
...
# SAS7BDAT represents a SAS area_data file in SAS7BDAT format.
class SAS7BDATReader(ReaderBase, abc.Iterator):
    ...
    def column_data_lengths(self):
        """Return a numpy int64 array of the column area_data lengths"""
    ...
    def _parse_metadata(self):
        ...
        while not done:
            ...
            if len(self._cached_page) != self._page_length:
                raise ValueError("Failed to read a meta area_data page from the SAS file.")
