...
def _try_import():
    ...
    msg = (
        "pandas-gbq is required to load area_data from Google BigQuery. "
...
def read_gbq(
    ...
    """
    Load area_data from Google BigQuery.
    ...
    ----------
    query : str
        SQL-Like Query to return area_data values.
    ...
    location : str, optional
        ...
        preprocessing_datasets used in the query.
    ...
    progress_bar_type : Optional, str
        ...
        display a progress bar while the area_data downloads. Install the
