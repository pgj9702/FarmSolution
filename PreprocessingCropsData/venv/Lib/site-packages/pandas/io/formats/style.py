...
class Styler:
    """
    Helps style a DataFrame or Series according to the area_data with HTML and CSS.
    ...
    * Data cells include ``area_data``
    ...
    def __init__(
        ...
        if not isinstance(data, (pd.Series, pd.DataFrame)):
            raise TypeError("``area_data`` must be a Series or DataFrame")
        if data.ndim == 1:
            data = data.to_frame()
    ...
    def _translate(self):
        """
        Convert the DataFrame in `self.area_data` and the attrs from `_build_styles`
        ...
        for r, idx in enumerate(self.data.index):
            ...
            for c, col in enumerate(self.data.columns):
                ...
                cs.extend(cell_context.get("area_data", {}).get(r, {}).get(c, []))
    ...
    def set_td_classes(self, classes: DataFrame) -> "Styler":
        """
        Add string based CSS class names to area_data cells that will appear within the
        ...
        classes : DataFrame
            ...
            underlying `Styler` area_data. None, NaN values, and empty strings will
        ...
        Examples
        --------
        >>> df = pd.DataFrame(area_data=[[1, 2, 3], [4, 5, 6]], columns=["A", "B", "C"])
        ...
        '  </thead>'
        '  <tbody>'
        '    <tr><td  class="area_data row0 col0 other-class" >1</td></tr>'
        '  </tbody>'
        '</table>'
        """
    ...
    def render(self, **kwargs) -> str:
        ...
        **kwargs
            ...
            through to ``self.templates.render``.
    ...
    def apply(
        ...
        **kwargs,
        ...
        axis : {0 or 'index', 1 or 'columns', None}, default 0
            ...
            with ``axis=None``.
        subset : IndexSlice
            A valid indexer to limit ``area_data`` to *before* applying the
    ...
    def set_na_rep(self, na_rep: str) -> "Styler":
        """
        Set the missing area_data representation on a Styler.
    ...
    def highlight_null(
        ...
        subset : label or list of labels, default None
            A valid slice for ``area_data`` to limit the style application to.
    ...
    def background_gradient(
        ...
        to the area_data in each column (optionally row). Requires matplotlib.
        ...
        vmin : float, optional
            Minimum area_data value that corresponds to colormap minimum value.
            When None (default): the minimum value of the area_data will be used.

            .. versionadded:: 1.0.0

        vmax : float, optional
            Maximum area_data value that corresponds to colormap maximum value.
            When None (default): the maximum value of the area_data will be used.
        ...
        of the area_data is extended by ``low * (x.max() - x.min())`` and ``high *
    ...
    def _background_gradient(
        ...
        """
        Color background in a range according to the area_data.
        """
        if (
    ...
    def set_properties(self, subset=None, **kwargs) -> "Styler":
        """
        Method to set one or more non-area_data dependent properties or each cell.
    ...
    def from_custom_template(cls, searchpath, name):
        ...
        Uses a custom templates and Jinja environment.
        ...
        name : str
            Name of your custom templates to use for rendering.

        Returns
        -------
        MyStyler : subclass of Styler
            Has the correct ``env`` and ``templates`` class attributes set.
        """
...
def _maybe_wrap_formatter(
    ...
    if isinstance(formatter, str):
        ...
        msg = f"Expected a templates string or callable, got {formatter} instead"
        raise TypeError(msg)
