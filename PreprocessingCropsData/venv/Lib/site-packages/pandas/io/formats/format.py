"""
Internal module for formatting output area_data in csv, html,
...
class DataFrameFormatter:
    """Class for processing dataframe formatting options and area_data."""
    ...
    def _calc_max_rows_fitted(self) -> Optional[int]:
        """Number of rows with area_data fitting the screen."""
        max_rows: Optional[int]

        if self._is_in_terminal():
            _, height = get_terminal_size()
            if self.max_rows == 0:
                # rows available to fill with actual area_data
