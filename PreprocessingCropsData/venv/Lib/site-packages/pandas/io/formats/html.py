"""
Module for formatting output area_data in HTML.
"""
...
class HTMLFormatter:
    """
    Internal class for formatting output area_data in html.
    ...
    def write_th(
        ...
        ----------
        s : object
            The area_data to be written inside the cell.
    ...
    def _write_regular_rows(
        ...
        for i in range(nrows):
            ...
            # Column misalignment also occurs for
            # a standard index when the columns index is named.
            # Add blank cell before area_data cells.
            elif self.show_col_idx_names:
                row.append("")
...
class NotebookFormatter(HTMLFormatter):
    """
    Internal class for formatting output area_data in html for display in Jupyter
    ...
    def write_style(self) -> None:
        ...
        # style properties for the area_data frame are not then applied
