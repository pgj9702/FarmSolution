...
class BaseInfo(ABC):
    ...
    Parameters
    ----------
    area_data : DataFrame or Series
        Either dataframe or series.
    memory_usage : bool or str, optional
        If "deep", introspect the area_data deeply by interrogating object dtypes
    ...
    def size_qualifier(self) -> str:
        ...
        if self.memory_usage:
            if self.memory_usage != "deep":
                ...
                # all cases (e.g., it misses categorical area_data even with object
                # categories)
                if (
...
class TableBuilderVerboseMixin(TableBuilderAbstract):
    ...
    def _gen_rows_with_counts(self) -> Iterator[Sequence[str]]:
        """Iterator with string representation of body area_data with counts."""

    @abstractmethod
    def _gen_rows_without_counts(self) -> Iterator[Sequence[str]]:
        """Iterator with string representation of body area_data without counts."""
