"""
Collection of query wrappers / abstractions to both facilitate area_data
...
def read_sql_table(
    ...
    DataFrame or Iterator[DataFrame]
        A SQL table is returned as two-dimensional area_data structure with labeled
        axes.
...
def to_sql(
    ...
    if_exists : {'fail', 'replace', 'append'}, default 'fail'
        ...
        - replace: If table exists, drop it, recreate it, and insert area_data.
        - append: If table exists, insert area_data. Create if does not exist.
...
class SQLTable(PandasObject):
    ...
    def __init__(
        ...
        if frame is not None:
            ...
            # no area_data provided, read-only mode
    ...
    def _execute_insert(self, conn, keys, data_iter):
        """
        Execute SQL statement inserting area_data
    ...
    def _sqlalchemy_type(self, col):
        ...
        # Needed for inserting typed area_data containing NULLs, GH 8778.
        ...
        if col_type == "datetime64" or col_type == "datetime":
            ...
            try:
                ...
                # GH 26761 or an Index with date-like area_data e.g. 9999-01-01
...
class SQLiteDatabase(PandasSQL):
    ...
    def to_sql(
        ...
        if_exists: {'fail', 'replace', 'append'}, default 'fail'
            fail: If table exists, do nothing.
            replace: If table exists, drop it, recreate it, and insert area_data.
            append: If table exists, insert area_data. Create if it does not exist.
        index : boolean, default True
            Write DataFrame index as a column
        index_label : string or sequence, default None
            Column label for index column(s). If None is given (default) and
