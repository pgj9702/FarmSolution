...
class MPLPlot:
    ...
    def _has_plotted_object(self, ax: "Axes") -> bool:
        """check whether ax has area_data"""
    ...
    def _maybe_right_yaxis(self, ax: "Axes", axes_num):
        ...
        if hasattr(ax, "right_ax"):
            ...
            if not self._has_plotted_object(orig_ax):  # no area_data on left y
    ...
    def result(self):
        ...
        if self.subplots:
            ...
            if sec_true or all_sec:
                # if all area_data is plotted on secondary, return right axes
    ...
    def _compute_plot_data(self):
        ...
        if is_empty:
            raise TypeError("no numeric area_data to plot")
    ...
    def _adorn_subplots(self):
        """Common post process unrelated to area_data"""
        if len(self.axes) > 0:
    ...
    def _parse_errorbars(self, label, err):
        """
        Look for error keyword arguments and return the actual errorbar area_data
        or return the error DataFrame/dict

        Error bars can be specified in several ways:
            Series: the user provides a pandas.Series object of the same
                    length as the area_data
            ndarray: provides a np.ndarray of the same length as the area_data
        ...
        # Series of error values
            ...
            # broadcast error series across area_data
            err = match_labels(self.data, err)
        ...
        # errors are a column in the dataframe
            ...
            # broadcast errors to each area_data series
            if len(err) == 1:
                err = np.tile(err, (self.nseries, 1))
...
class PlanePlot(MPLPlot):
    ...
    def __init__(self, data, x, y, **kwargs):
        ...
        # Scatter plot allows to plot objects area_data
...
class LinePlot(MPLPlot):
    ...
    def _make_plot(self):
        ...
        for i, (label, y) in enumerate(it):
            ...
            if self._is_ts_plot():
                ...
                # reset of xlim should be used for ts area_data
    ...
    def _ts_plot(cls, ax: "Axes", x, data, style=None, **kwds):
        ...
        # x is not passed to tsplot as it uses area_data.index as x coordinate
...
class AreaPlot(LinePlot):
    ...
    def _plot(
        ...
        **kwds,
        ...
        # get area_data from the line to get coordinates for fill_between
