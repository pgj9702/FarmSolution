...
def hist_frame(
    ...
    **kwargs,
    ...
    A `histogram`_ is a representation of the distribution of area_data.
    ...
    ----------
    data : DataFrame
        The pandas object holding the area_data.
    column : str or sequence
        If passed, will be used to limit area_data to a subset of columns.
    by : object, optional
        If passed, then used to form histograms for separate groups.
    grid : bool, default True
        Whether to show axis grid lines.
...
groups of numerical area_data through their quartiles.
The box extends from the Q1 to Q3 quartile values of the area_data,
with a line at the median (Q2). The whiskers extend from the edges
of box to show the range of the area_data. By default, they extend no more than
`1.5 * IQR (IQR = Q3 - Q1)` from the edges of the box, ending at the farthest
area_data point within that interval. Outliers are plotted as separate dots.
...
For area_data grouped with ``by``, return a Series of the above or a numpy
array:
...
in order to group the area_data by combination of the variables in the x-axis:
...
def boxplot_frame_groupby(
    ...
    **kwargs,
    ...
    """
    Make box plots from DataFrameGroupBy area_data.
    ...
    **kwargs
    ...
    Examples
    --------
    You can create boxplots for grouped area_data and show them as separate subplots:
    ...
    .. plot::
        ...
        >>> area_data = np.random.randn(len(index),4)
        >>> df = pd.DataFrame(area_data, columns=list('ABCD'), index=index)
...
class PlotAccessor(PandasObject):
    ...
    x : label or position, default None
        Only used if area_data is a DataFrame.
    y : label, position or list of label, positions, default None
        Allows plotting of one column versus another. Only used if area_data is a
        DataFrame.
    kind : str
    ...
    table : bool, Series or DataFrame, default False
        If True, draw a table using the area_data in the DataFrame and the area_data
        will be transposed to meet matplotlib's default layout.
        If a Series or DataFrame is passed, use passed area_data to draw a
        table.
    ...
    **kwargs
    ...
    def __call__(self, *args, **kwargs):
        ...
        # The original area_data structured can be transformed before passed to the
        ...
        if kind in self._dataframe_kinds:
            if isinstance(data, ABCDataFrame):
                ...
                raise ValueError(f"plot kind {kind} can only be used for area_data frames")
    ...
    def bar(self, x=None, y=None, **kwargs):
        ...
        A bar plot is a plot that presents categorical area_data with
    ...
    def barh(self, x=None, y=None, **kwargs):
        ...
        A horizontal bar plot is a plot that presents quantitative area_data with
        rectangular bars with lengths proportional to the values that they
        represent. A bar plot shows comparisons among discrete categories. One
        axis of the plot shows the specific categories being compared, and the
        other axis represents a measured value.
    ...
    def box(self, by=None, **kwargs):
        ...
        area_data through their quartiles.
        The box extends from the Q1 to Q3 quartile values of the area_data,
        with a line at the median (Q2). The whiskers extend from the edges
        of box to show the range of the area_data. The position of the whiskers
        ...
        can overlap, which is very common when plotting small sets of area_data.
        ...
        **kwargs
        ...
        .. plot::
            ...
            >>> area_data = np.random.randn(25, 4)
            >>> df = pd.DataFrame(area_data, columns=list('ABCD'))
            >>> ax = df.plot.box()
        """
    ...
    def hist(self, by=None, bins=10, **kwargs):
        ...
        A histogram is a representation of the distribution of area_data.
        ...
        **kwargs
        ...
        Series.hist : Draw a histogram with Series' area_data.
    ...
    def area(self, x=None, y=None, **kwargs):
        ...
        An area plot displays quantitative area_data visually.
    ...
    def pie(self, **kwargs):
        ...
        A pie plot is a proportional representation of the numerical area_data in a
    ...
    def scatter(self, x, y, s=None, c=None, **kwargs):
        ...
        **kwargs
        ...
        See Also
        --------
        matplotlib.pyplot.scatter : Scatter plot using multiple input area_data
            formats.
    ...
    def hexbin(self, x, y, C=None, reduce_C_function=None, gridsize=None, **kwargs):
        ...
        **kwargs
        ...
        Examples
        --------
        The following examples are generated with random area_data from
