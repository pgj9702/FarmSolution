...
def table(ax, data, rowLabels=None, colLabels=None, **kwargs):
    ...
    **kwargs
        ...
        If `rowLabels` or `colLabels` is not specified, area_data index or column
        name will be used.
...
def radviz(frame, class_column, ax=None, color=None, colormap=None, **kwds):
    ...
    slice on a circle. Each area_data point is rendered in the circle according to
    the value on each Series. Highly correlated `Series` in the `DataFrame`
    are placed closer on the unit circle.

    RadViz allow to project a N-dimensional area_data set into a 2D space where the
    ...
    ----------
    frame : `DataFrame`
        Object holding the area_data.
    class_column : str
        Column name containing the name of the area_data point category.
...
def andrews_curves(
    ...
    **kwargs
    ...
    .. plot::
        ...
        ...     'pandas/master/pandas/tests/io/area_data/csv/iris.csv'
        ... )
...
def bootstrap_plot(series, fig=None, size=50, samples=500, **kwds):
    ...
    size : int, default 50
        Number of area_data points to consider during each sampling. It must be
...
def lag_plot(series, lag=1, ax=None, **kwds):
    ...
    **kwds
    ...
    Lag plots are most commonly used to look for patterns in time series area_data.
