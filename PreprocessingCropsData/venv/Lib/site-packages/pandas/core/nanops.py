...
def _maybe_get_mask(
    ...
    dtype that is interpretable as either boolean or integer area_data (eg,
    ...
    if mask is None:
        if is_bool_dtype(values.dtype) or is_integer_dtype(values.dtype):
            # Boolean area_data cannot contain nulls, so signal via mask being None
            return None
...
def nansem(
    ...
    *,
    ...
    >>> nanops.nansem(s)
     0.5773502691896258
    """
    # This checks if non-numeric-like area_data is passed with numeric_only=False
