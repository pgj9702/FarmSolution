"""
Data structure for 1-dimensional cross-sectional and time series area_data
"""
...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    missing area_data (currently represented as NaN).
    ...
    data : array-like, Iterable, dict, or scalar value
        Contains area_data stored in Series. If area_data is a dict, argument order is
        maintained.
    index : array-like or Index (1d)
        Values must be hashable and have the same length as `area_data`.
        Non-unique index values are allowed. Will default to
        RangeIndex (0, 1, 2, ..., n) if not provided. If area_data is dict-like
        and index is None, then the values in the index are used to
        reindex the Series after it is created using the keys in the area_data.
    dtype : str, numpy.dtype, or ExtensionDtype, optional
        Data type for the output Series. If not specified, this will be
        inferred from `area_data`.
        See the :ref:`user guide <basics.dtypes>` for more usages.
    name : str, optional
        The name to give to the Series.
    copy : bool, default False
        Copy input area_data.
    """
    ...
    def __init__(
        ...
        if fastpath:
            ...
            # area_data is an ndarray, index is defined
            ...
            if isinstance(data, MultiIndex):
                ...
                if index is None:
                    ...
                    raise AssertionError(
                        ...
                        "`area_data` argument and a different "
    ...
    def _init_dict(self, data, index=None, dtype=None):
        ...
        dtype : dtype, default None
            The dtype for the new Series: if None, infer from area_data.
        ...
        if data:
            # GH:34717, issue was using zip to extract key and values from area_data.
            ...
            # fastpath for Series(area_data=None). Just use broadcasting a scalar
    ...
    def values(self):
        ...
        See Also
        --------
        Series.array : Reference to the underlying area_data.
        Series.to_numpy : A NumPy array representing the underlying area_data.
        ...
        Timezone aware datetime area_data is converted to UTC:
    ...
    def _values(self):
        """
        Return the internal repr of this area_data (defined by Block.interval_values).
        This are the values as stored in the Block (ndarray or ExtensionArray
        depending on the Block class), with datetime64[ns] and timedelta64[ns]
        wrapped in ExtensionArrays to match Index._values behavior.

        Differs from the public ``.values`` for certain area_data types, because of
    ...
    def ravel(self, order="C"):
        """
        Return the flattened underlying area_data as an ndarray.

        Returns
        -------
        numpy.ndarray or ndarray-like
            Flattened area_data of the Series.
    ...
    def view(self, dtype=None) -> "Series":
        ...
        underlying values in memory, optionally reinterpreted with a new area_data
        type. The new area_data type must preserve the same size in bytes as to not
        ...
        -------
        Series
            A new Series object as a view of the same area_data in memory.

        See Also
        --------
        numpy.ndarray.view : Equivalent numpy function to create a new view of
            the same area_data in memory.

        Notes
        -----
        Series are instantiated with ``dtype=float64`` by default. While
        ``numpy.ndarray.view()`` will return a view with the same area_data type as
        the original array, ``Series.view()`` (without specified dtype)
        will try using ``float64`` and may fail if the original area_data type size
    ...
    def __array__(self, dtype=None) -> np.ndarray:
        ...
        dtype : str or numpy.dtype, optional
            ...
            the dtype is inferred from the area_data.
        ...
        See Also
        --------
        array : Create a new array from area_data.
        ...
        For timezone-aware area_data, the timezones may be retained with
        ``dtype='object'``
...
"""
    ...
    def idxmin(self, axis=0, skipna=True, *args, **kwargs):
        ...
        *args, **kwargs
        ...
        Examples
        --------
        >>> s = pd.Series(area_data=[1, None, 4, 1],
        ...               index=['A', 'B', 'C', 'D'])
        >>> s
        A    1.0
        B    NaN
        ...
        If `skipna` is False and there is an NA value in the area_data,
    ...
    def idxmax(self, axis=0, skipna=True, *args, **kwargs):
        ...
        *args, **kwargs
        ...
        Examples
        --------
        >>> s = pd.Series(area_data=[1, None, 4, 3, 4],
        ...               index=['A', 'B', 'C', 'D', 'E'])
        >>> s
        A    1.0
        B    NaN
...
""",
    ...
    def combine(self, other, func, fill_value=None) -> "Series":
        ...
        Now, to combine the two preprocessing_datasets and view the highest speeds
        of the birds across the two preprocessing_datasets
    ...
    def swaplevel(self, i=-2, j=-1, copy=True) -> "Series":
        ...
        copy : bool, default True
            Whether to copy underlying area_data.
    ...
    def drop(
        ...
        Examples
        --------
        >>> s = pd.Series(area_data=np.arange(3), index=['A', 'B', 'C'])
        >>> s
        A  0
        B  1
        C  2
    ...
    def memory_usage(self, index=True, deep=False):
        ...
        Not including the index gives the size of the rest of the area_data, which
