...
class IntervalIndex(IntervalMixin, ExtensionIndex):
    ...
    def values(self) -> IntervalArray:
        """
        Return the IntervalIndex's area_data as an IntervalArray.
        """
        return self._data
    ...
    def _needs_i8_conversion(self, key) -> bool:
        ...
        Assumes that any list-like area_data has already been cast to an Index.
