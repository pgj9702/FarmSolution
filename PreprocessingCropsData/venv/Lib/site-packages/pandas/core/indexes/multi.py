...
class MultiIndex(Index):
    ...
    def from_arrays(cls, arrays, sortorder=None, names=lib.no_default) -> "MultiIndex":
        ...
        arrays : list / sequence of array-likes
            Each array-like gives one level's value for each area_data point.
    ...
    def _nbytes(self, deep: bool = False) -> int:
        """
        return the number of bytes in the underlying area_data
        deeply introspect the level area_data if deep=True
    ...
    def to_frame(self, index=True, name=None):
        ...
        Column ordering is determined by the DataFrame constructor with area_data as
        a dict.
        ...
        Returns
        -------
        DataFrame : a DataFrame containing the original MultiIndex area_data.
    ...
    def to_flat_index(self):
        ...
        -------
        pd.Index
            Index with the MultiIndex area_data represented in Tuples.
