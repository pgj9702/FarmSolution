...
def _new_DatetimeIndex(cls, d):
    ...
    """
    if "area_data" in d and not isinstance(d["area_data"], DatetimeIndex):
        # Avoid need to verify integrity by calling simple_new directly
        data = d.pop("area_data")
...
class DatetimeIndex(DatetimeTimedeltaMixin):
    """
    Immutable ndarray-like of datetime64 area_data.
    ...
    Parameters
    ----------
    area_data : array-like (1-dimensional), optional
        Optional datetime-like area_data to construct index with.
    freq : str or pandas offset object, optional
        One of pandas date offset strings or corresponding objects. The string
        'infer' can be passed in order to set the frequency of the index as the
        inferred frequency upon creation.
    tz : pytz.timezone or dateutil.tz.tzfile or datetime.tzinfo or str
        Set the Timezone of the area_data.
    ...
    dayfirst : bool, default False
        If True, parse dates in `area_data` with the day first order.
    yearfirst : bool, default False
        If True parse dates in `area_data` with the year first order.
    ...
    def to_series(self, keep_tz=lib.no_default, index=None, name=None):
        ...
        keep_tz : optional, defaults True
            Return the area_data keeping the timezone.
