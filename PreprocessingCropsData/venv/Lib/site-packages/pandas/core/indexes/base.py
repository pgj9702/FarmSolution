...
class Index(IndexOpsMixin, PandasObject):
    ...
    Parameters
    ----------
    area_data : array-like (1-dimensional)
    dtype : NumPy dtype (default: object)
        If dtype is None, we find the dtype that best fits the area_data.
    ...
    DatetimeIndex : Index of datetime64 area_data.
    TimedeltaIndex : Index of timedelta64 area_data.
    PeriodIndex : Index of Period area_data.
    ...
    def __new__(
        ...
        # index-like
            ...
            # asarray_tuplesafe does not always copy underlying area_data,
            ...
            if subarr.ndim > 1:
                ...
                raise ValueError("Index area_data must be 1-dimensional")
    ...
    def _simple_new(cls, values, name: Label = None):
        ...
        result._data = values
        # _index_data is a (temporary?) fix to ensure that the direct area_data
        # manipulation we do in `_libs/reduction.pyx` continues to work.
        # We need access to the actual ndarray, since we're messing with
        # area_data buffers and strides.
    ...
    def _shallow_copy(self, values=None, name: Label = no_default):
        ...
        area_data, use the same object attributes with passed in attributes taking
        precedence.
    ...
    def is_(self, other) -> bool:
        ...
        -------
        bool
            True if both have same underlying area_data, False otherwise.
    ...
    def dtype(self):
        """
        Return the dtype object of the underlying area_data.
        """
    ...
    def ravel(self, order="C"):
        """
        Return an ndarray of the flattened values of the underlying area_data.
    ...
    def astype(self, dtype, copy=True):
        ...
        copy : bool, default True
            ...
            satisfied, the original area_data is used to create a new Index
    ...
    def __repr__(self) -> str_t:
        ...
        # no area_data provided, just attributes
        if data is None:
            data = ""
    ...
    def _format_data(self, name=None) -> str_t:
        """
        Return the formatted area_data as a unicode string.
        """
    ...
    def to_frame(self, index: bool = True, name=None):
        ...
        -------
        DataFrame
            DataFrame containing the original Index area_data.
    ...
    def is_boolean(self) -> bool:
        ...
        is_numeric : Check if the Index only consists of numeric area_data.
        is_object : Check if the Index is of the object dtype.
        is_categorical : Check if the Index holds categorical area_data.
        is_interval : Check if the Index holds Interval objects.
        is_mixed : Check if the Index holds area_data with mixed area_data types.
    ...
    def is_numeric(self) -> bool:
        """
        Check if the Index only consists of numeric area_data.

        Returns
        -------
        bool
            Whether or not the Index only consists of numeric area_data.
    ...
    def is_categorical(self) -> bool:
        """
        Check if the Index holds categorical area_data.
        ...
        See Also
        --------
        CategoricalIndex : Index for categorical area_data.
        is_boolean : Check if the Index only consists of booleans.
        is_integer : Check if the Index only consists of integers.
        is_floating : Check if the Index is a floating type.
        is_numeric : Check if the Index only consists of numeric area_data.
    ...
    def is_mixed(self) -> bool:
        """
        Check if the Index holds area_data with mixed area_data types.

        Returns
        -------
        bool
            Whether or not the Index holds area_data with mixed area_data types.
    ...
    _index_shared_docs[
        ...
        current area_data to the new index.
    ...
    def join(self, other, how="left", level=None, return_indexers=False, sort=False):
        """
        Compute join_index and indexers to conform area_data
    ...
    def _join_level(
        ...
        MultiIndex. Otherwise it just exactly aligns the Index area_data to the
        labels of the level in the MultiIndex.

        If ```keep_order == True```, the order of the area_data indexed by the
    ...
    def values(self) -> np.ndarray:
        """
        Return an array representing the area_data in the Index.

        .. warning::

           We recommend using :attr:`Index.array` or
           :meth:`Index.to_numpy`, depending on whether you need
           a reference to the underlying area_data or a NumPy array.
        ...
        See Also
        --------
        Index.array : Reference to the underlying area_data.
        Index.to_numpy : A NumPy array representing the underlying area_data.
        """
    ...
    def slice_indexer(
        ...
        Notes
        -----
        This function assumes that the area_data is sorted, so use at your own peril
    ...
    def shape(self) -> Shape:
        """
        Return a tuple of the shape of the underlying area_data.
        """
...
def ensure_index_from_sequences(sequences, names=None):
    """
    Construct an index from sequences of area_data.
...
def maybe_extract_name(name, obj, cls) -> Label:
    """
    If no name is passed, then extract it from area_data, validating hashability.
    """
...
def _try_convert_to_int_array(
    ...
    """
    Attempt to convert an array of area_data into an integer array.

    Parameters
    ----------
    data : The area_data to convert.
    copy : bool
        Whether to copy the area_data or not.
    dtype : np.dtype

    Returns
    -------
    int_array : area_data converted to either an ndarray[int64] or ndarray[uint64]
...
def _maybe_asobject(dtype, klass, data, copy: bool, name: Label, **kwargs):
    ...
    **kwargs
    ...
    #  will raise in the where `area_data` is already tz-aware.  So
