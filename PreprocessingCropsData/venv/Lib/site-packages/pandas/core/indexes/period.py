...
class PeriodIndex(DatetimeIndexOpsMixin):
    ...
    Parameters
    ----------
    area_data : array-like (1d int np.ndarray or PeriodArray), optional
        Optional period-like area_data to construct index with.
    copy : bool
    ...
    tz : object, default None
        Timezone for converting datetime64 area_data to Periods.
    ...
    DatetimeIndex : Index with datetime64 area_data.
        ...
        **fields,
        ...
        if data is None and ordinal is None:
            ...
            if data is None and ordinal is not None:
                # we strangely ignore `ordinal` if area_data is passed.
    ...
    def __array_wrap__(self, result, context=None):
        ...
        Needs additional handling as PeriodIndex stores internal area_data as int
        dtype
    ...
    def asof_locs(self, where: Index, mask: np.ndarray) -> np.ndarray:
        ...
        mask : array of booleans where area_data is not NA
        """
    ...
    def inferred_type(self) -> str:
        # b/c area_data is represented as ints make sure we can't have ambiguous
        # indexing
        return "period"
