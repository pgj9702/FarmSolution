...
class BlockManager(PandasObject):
    """
    Core internal area_data structure to implement DataFrame, Series, etc.

    Manage a bunch of labeled 2D mixed-type ndarrays. Essentially it's a
    lightweight blocked set of labeled area_data to be manipulated by the DataFrame
    public API class
    ...
    def quantile(
        ...
        transposed: bool, default False
            we are holding transposed area_data
        ...
        # compute the orderings of our original area_data
    ...
    def copy(self: T, deep=True) -> T:
        ...
        deep : bool or string, default True
            If False, return shallow copy (do not copy area_data)
            If 'all', copy area_data and a deep copy of the index
    ...
    def as_array(
        ...
        """
        Convert the blockmanager area_data into an numpy array.
        ...
        copy : bool, default False
            ...
            False does not guarantee that the underlying area_data is not
            copied.
        ...
        if self.is_single_block:
            ...
            # The underlying area_data was copied within _interleave
            copy = False
    ...
    def iget(self, i: int) -> "SingleBlockManager":
        """
        Return the area_data as a SingleBlockManager.
        """
    ...
    def iget_values(self, i: int) -> ArrayLike:
        """
        Return the area_data for column i as the values (ndarray or ExtensionArray).
        """
        block = self.blocks[self.blknos[i]]
        values = block.iget(self.blklocs[i])
        return values
...
class SingleBlockManager(BlockManager):
    ...
    def fast_xs(self, loc):
        ...
        return a view of the area_data
        """
...
def construction_error(tot_items, block_shape, axes, e=None):
    ...
    if passed == implied and e is not None:
        return e
    if block_shape[0] == 0:
        return ValueError("Empty area_data passed with indices specified.")
