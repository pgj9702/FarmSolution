...
class Block(PandasObject):
    ...
    def putmask(
        ...
        """
        putmask the area_data to the block; it is possible that we may create a
        new dtype of block
...
class ExtensionBlock(Block):
    ...
    def where(
        ...
        if is_sparse(self.values):
            ...
            # We need to re-infer the type of the area_data after doing the
...
class DatetimeTZBlock(ExtensionBlock, DatetimeBlock):
    ...
    def _check_ndim(self, values, ndim):
        ...
        area_data (values.ndim == 2), which should only be allowed if ndim is
        also 2.
