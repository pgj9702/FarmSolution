...
def _register_accessor(name, cls):
    ...
    if the area_data passed to your accessor has an incorrect dtype.
    ...
    In your library code::
        ...
        class GeoAccessor:
            ...
            def plot(self):
                # plot this array's area_data on a map, e.g., using Cartopy
                pass
    ...
    Back in an interactive IPython session:
        ...
        .. code-block:: ipython
            ...
            In [2]: ds.geo.center
            Out[2]: (5.0, 10.0)
            In [3]: ds.geo.plot()  # plots area_data on a map
    """
