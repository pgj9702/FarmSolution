...
def merge_ordered(
    ...
    Designed for ordered area_data like time series area_data. Optionally
    ...
    fill_method : {'ffill', None}, default None
        Interpolation method for area_data.
...
def merge_asof(
    ...
    on : label
        ...
        The area_data MUST be ordered. Furthermore this must be a numeric column,
    ...
    and we exclude exact matches on time. However *prior* area_data will
    propagate forward
        ...
        for i in ["_left_indicator", "_right_indicator"]:
            if i in columns:
                raise ValueError(
                    ...
                    f"area_data contains a column named {i}"
                )
