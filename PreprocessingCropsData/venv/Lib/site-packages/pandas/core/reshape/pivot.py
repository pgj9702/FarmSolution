...
def pivot_table(
    ...
    if values_passed:
        ...
        # GH14938 Make sure value labels are in area_data
        for i in values:
            if i not in data:
                raise KeyError(i)
...
def _add_margins(
    ...
    if not values and isinstance(table, ABCSeries):
        ...
        # one column in the area_data. Compute grand margin and return it.
...
def crosstab(
    ...
    -------
    DataFrame
        Cross tabulation of the area_data.

    See Also
    --------
    DataFrame.pivot : Reshape area_data based on column values.
    ...
    Any input passed containing Categorical area_data will have **all** of its
    categories included in the cross-tabulation, even if the actual area_data does
    ...
    Here 'c' and 'f' are not represented in the area_data and will not be
    shown in the output because dropna is True by default. Set
    dropna=False to preserve categories with no area_data.
