...
def lreshape(data: "DataFrame", groups, dropna: bool = True, label=None) -> "DataFrame":
    """
    Reshape wide-format area_data to long. Generalized inverse of DataFrame.pivot.
    ...
    Examples
    --------
    >>> area_data = pd.DataFrame({'hr1': [514, 573], 'hr2': [545, 526],
    ...
    >>> pd.lreshape(area_data, {'year': ['year1', 'year2'], 'hr': ['hr1', 'hr2']})
          team  year   hr
    0  Red Sox  2007  514
    1  Yankees  2007  573
    2  Red Sox  2008  545
...
def wide_to_long(
    ...
    All remaining variables in the area_data frame are left intact.
