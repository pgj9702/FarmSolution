...
def concat(
    ...
    verify_integrity : bool, default False
        ...
        be very expensive relative to the actual area_data concatenation.
    ...
    copy : bool, default True
        If False, do not copy area_data unnecessarily.
    ...
    the area_data with the ``keys`` option.
...
class _Concatenator:
    ...
    def __init__(
        ...
        # consolidate area_data & figure out what our result ndim is going to be
        ndims = set()
        for obj in objs:
