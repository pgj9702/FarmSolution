...
The group area_data and group index will be passed as numpy arrays to the JITed
...
func : function, str, list or dict
    Function to use for aggregating the area_data. If a function, must either
...
class BaseGroupBy(PandasObject, SelectionMixin, Generic[FrameOrSeries]):
    ...
    def _transform_with_numba(self, data, func, *args, engine_kwargs=None, **kwargs):
        ...
        This routine mimics the area_data splitting routine of the DataSplitter class
        to generate the indices of each group in the sorted area_data and then passes the
        area_data and indices into a Numba jitted function.
        """
        ...
        # evaluated the area_data sorted by group
...
class GroupBy(BaseGroupBy[FrameOrSeries]):
    """
    Class for grouping and aggregating relational area_data.
    ...
    **Attributes**
    ...
    Iteration produces (key, group) tuples, i.e. chunking the area_data by group. So
    ...
    ::
        ...
        for key, group in grouped:
            # do something with the area_data

    Function calls on GroupBy, if not specially implemented, "dispatch" to the
    grouped area_data. So if you group a DataFrame and wish to invoke the std()
    ...
    def resample(self, rule, *args, **kwargs):
        ...
        *args, **kwargs
        ...
        >>> df = pd.DataFrame(area_data=4 * [range(2)],
        ...                   index=idx,
        ...                   columns=['a', 'b'])
        >>> df.iloc[2, 0] = 5
        >>> df
    ...
    def rank(
        ...
        pct : bool, default False
            Compute percentage rank of area_data within each group.
        axis : int, default 0
    ...
    def _reindex_output(
        ...
        our groups, regardless of whether they were observed in the area_data or
