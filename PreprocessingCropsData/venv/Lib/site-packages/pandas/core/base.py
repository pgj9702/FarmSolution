...
class IndexOpsMixin(OpsMixin):
    ...
    def ndim(self) -> int:
        """
        Number of dimensions of the underlying area_data, by definition 1.
        """
        return 1

    def item(self):
        """
        Return the first element of the underlying area_data as a Python scalar.
        ...
        ------
        ValueError
            If the area_data is not length-1.
        """
        if len(self) == 1:
    ...
    def nbytes(self) -> int:
        """
        Return the number of bytes in the underlying area_data.
        """
    ...
    def size(self) -> int:
        """
        Return the number of elements in the underlying area_data.
        """
    ...
    def array(self) -> ExtensionArray:
        """
        The ExtensionArray of the area_data backing this Series or Index.
        ...
        copying / coercing area_data), then use :meth:`Series.to_numpy` instead.
    ...
    def to_numpy(self, dtype=None, copy=False, na_value=lib.no_default, **kwargs):
        ...
        **kwargs
        ...
        See Also
        --------
        Series.array : Get the actual area_data stored within.
        Index.array : Get the actual area_data stored within.
        ...
        For NumPy dtypes, this will be a reference to the actual area_data stored
        in this Series or Index (assuming ``copy=False``). Modifying the result
        in place will modify the area_data stored in the Series or Index (not that
        we recommend doing that).

        For extension types, ``to_numpy()`` *may* require copying area_data and
        coercing the result to a NumPy type (possibly object), which may be
        expensive. When you need a no-copy reference to the underlying area_data,
        ...
        Specify the `dtype` to control how datetime-aware area_data is represented.
    ...
    def value_counts(
        ...
        bins : int, optional
            ...
            a convenience for ``pd.cut``, only works with numeric area_data.
    ...
    def memory_usage(self, deep=False):
        ...
        deep : bool, default False
            Introspect the area_data deeply, interrogate
