...
missing area_data in either one of the inputs.
...
fill_value : None or float value, default None (NaN)
    ...
    If area_data in both corresponding Series locations is missing
...
for missing area_data in one of the inputs. With reverse version, `{reverse}`.
...
other : scalar, sequence, Series, or DataFrame
    Any single or multiple element area_data structure, or list-like object.
...
fill_value : float or None, default None
    ...
    If area_data in both corresponding DataFrame locations is missing
