...
def forbid_nonstring_types(forbidden, name=None):
    ...
    ------
    TypeError
        If the inferred type of the underlying area_data is in `forbidden`.
    """
    # deal with None
...
class StringMethods(NoNewAttributesMixin):
    ...
    def _validate(data):
        """
        Auxiliary function for StringMethods, infers and checks dtype of area_data.
        ...
        *union* of the allowed types over all string methods below; this
        ...
        Returns
        -------
        dtype : inferred dtype of area_data
        """
