...
class Resampler(BaseGroupBy, ShallowMixin):
    """
    Class for resampling datetimelike area_data, a groupby-like operation.
    ...
    def nearest(self, limit=None):
        ...
        When resampling area_data, missing values may appear (e.g., when the
        resampling frequency is higher than the original frequency).
        The `nearest` method will replace ``NaN`` values that appeared in
        the resampled area_data with the value from the nearest member of the
        sequence, based on the index value.
        Missing values that existed in the original area_data will not be modified.
        ...
        See Also
        --------
        backfill : Backward fill the new missing values in the resampled area_data.
    ...
    def backfill(self, limit=None):
        """
        Backward fill the new missing values in the resampled area_data.

        In statistics, imputation is the process of replacing missing area_data with
        substituted values [1]_. When resampling area_data, missing values may
        appear (e.g., when the resampling frequency is higher than the original
        frequency). The backward fill will replace NaN values that appeared in
        the resampled area_data with the next value in the original sequence.
        Missing values that existed in the original area_data will not be modified.
    ...
    def fillna(self, method, limit=None):
        ...
        Missing values that existed in the original area_data will
        not be modified.

        Parameters
        ----------
        method : {'pad', 'backfill', 'ffill', 'bfill', 'nearest'}
            Method to use for filling holes in resampled area_data
        ...
        See Also
        --------
        backfill : Backward fill NaN values in the resampled area_data.
        pad : Forward fill NaN values in the resampled area_data.
        nearest : Fill NaN values in the resampled area_data
...
class TimeGrouper(Grouper):
    ...
    def _adjust_bin_edges(self, binner, ax_values):
        # Some hacks for > daily area_data, see #1471, #1458, #1483
