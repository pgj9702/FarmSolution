...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    size-mutable, labeled area_data structure
    ...
    def set_flags(
        ...
        *,
        ...
        Notes
        -----
        This method returns a new object that's a view on the same area_data
    ...
    def rename(
        ...
        *,
        ...
        copy : bool, default True
            Also copy underlying area_data.
        inplace : bool, default False
    ...
    def bool(self):
        ...
        See Also
        --------
        Series.astype : Change the area_data type of a Series, including to boolean.
        DataFrame.astype : Change the area_data type of a DataFrame, including to boolean.
        numpy.bool_ : NumPy boolean area_data type, used by pandas for boolean values.
    ...
    def empty(self) -> bool_t:
        ...
        DataFrame.dropna : Return DataFrame with labels on given axis omitted
            where (all or any) area_data are missing.
    ...
    #    values = self.values
    #    return dict(typestr=values.dtype.str,shape=values.shape,area_data=values)
    ...
    def to_excel(
        ...
        With all area_data written to the file it is necessary to save the changes.
        ...
        na_rep : str, default ''
            Missing area_data representation.
        ...
        Once a workbook has been saved it is not possible write further area_data
    ...
    def to_json(
        ...
        orient : str
            ...
            * The format of the JSON string:
                ...
                - 'table' : dict like {{'schema': {{schema}}, 'area_data': {{area_data}}}}

                Describing the area_data, where area_data component is like ``orient='records'``.
    ...
    def to_hdf(
        ...
        """
        Write the contained area_data to an HDF5 file using HDFStore.
        ...
        complevel : {0-9}, optional
            Specifies a compression level for area_data.
        ...
        append : bool, default False
            For Table formats, append the input area_data to the existing.
        format : {'fixed', 'table', None}, default 'fixed'
            ...
            - 'table': Table format. Write as a PyTables Table structure
              ...
              like searching / selecting subsets of the area_data.
        ...
        data_columns : list of columns or True, optional
            List of columns to create as indexed area_data columns for on-disk
            queries, or True to use all columns. By default only the axes
            of the object are indexed. See :ref:`io.hdf5-query-area_data-columns`.
        ...
        >>> df = pd.DataFrame({'A': [1, 2, 3], 'B': [4, 5, 6]},
        ...                   index=['a', 'b', 'c'])
        >>> df.to_hdf('area_data.h5', key='df', mode='w')

        We can add another object to the same file:

        >>> s = pd.Series([1, 2, 3, 4])
        >>> s.to_hdf('area_data.h5', key='s')

        Reading from HDF file:

        >>> pd.read_hdf('area_data.h5', 'df')
        A  B
        a  1  4
        b  2  5
        c  3  6
        >>> pd.read_hdf('area_data.h5', 's')
        0    1
        1    2
        2    3
        3    4
        ...
        Deleting file with area_data:

        >>> import os
        >>> os.remove('area_data.h5')
        """
    ...
    def to_sql(
        ...
        Notice that while pandas is forced to store the area_data as floating point,
        the database supports nullable integers. When fetching the area_data with
    ...
    def xs(self, key, axis=0, level=None, drop_level: bool_t = True):
        ...
        This method takes a `key` argument to select area_data at a particular
    ...
    def reindex_like(
        ...
        Parameters
        ----------
        other : Object of the same area_data type
    ...
    def reindex(self: FrameOrSeries, *args, **kwargs) -> FrameOrSeries:
        ...
        {axes} : array-like, optional
            ...
            keywords. Preferably an Index object to avoid duplicating area_data.
        {optional_axis}
        method : {{None, 'backfill'/'bfill', 'pad'/'ffill', 'nearest'}}
            Method to use for filling holes in reindexed DataFrame.
            Please note: this is only applicable to DataFrames/Series with a
        ...
        * ``(labels, axis={{'index', 'columns'}}, ...)``
        ...
        Create a dataframe with some fictional area_data.
        ...
        The index entries that did not have a value in the original area_data frame
    ...
    def head(self: FrameOrSeries, n: int = 5) -> FrameOrSeries:
        ...
        has the right type of area_data in it.
    ...
    def tail(self: FrameOrSeries, n: int = 5) -> FrameOrSeries:
        ...
        position. It is useful for quickly verifying area_data, for example,
    ...
    def sample(
        ...
        axis : {0 or ‘index’, 1 or ‘columns’, None}, default None
            ...
            for given area_data type (0 for Series and DataFrames).
    ...
    def pipe(self, func, *args, **kwargs):
        ...
        If you have a function that takes the area_data as (say) the second
        argument, pass a tuple indicating which keyword expects the
        area_data. For example, suppose ``f`` takes its area_data as ``arg2``:
    ...
    def _consolidate_inplace(self) -> None:
        """Consolidate area_data in place and return None"""
    ...
    def _consolidate(self):
        """
        Compute NDFrame with "consolidated" internals (area_data of each dtype
    ...
    def dtypes(self):
        ...
        This returns a Series with the area_data type of each column.
        ...
        -------
        pandas.Series
            The area_data type of each column.
    ...
    def astype(
        ...
        Parameters
        ----------
        dtype : area_data type, or dict of column name -> area_data type
        ...
        errors : {'raise', 'ignore'}, default 'raise'
            Control raising of exceptions on invalid area_data for provided dtype.
        ...
        Note that using ``copy=False`` and changing area_data on a new
    ...
    def copy(self: FrameOrSeries, deep: bool_t = True) -> FrameOrSeries:
        """
        Make a copy of this object's indices and area_data.

        When ``deep=True`` (default), a new object will be created with a
        copy of the calling object's area_data and indices. Modifications to
        the area_data or indices of the copy will not be reflected in the
        original object (see notes below).

        When ``deep=False``, a new object will be created without copying
        the calling object's area_data or index (only references to the area_data
        and index are copied). Any changes to the area_data of the original
        will be reflected in the shallow copy (and vice versa).

        Parameters
        ----------
        deep : bool, default True
            Make a deep copy, including a copy of the area_data and the indices.
            With ``deep=False`` neither the indices nor the area_data are copied.
        ...
        Notes
        -----
        When ``deep=True``, area_data is copied but actual Python objects
        will not be copied recursively, only the reference to the object.
        This is in contrast to `copy.deepcopy` in the Standard Library,
        which recursively copies object area_data (see examples below).

        While ``Index`` objects are copied when ``deep=True``, the underlying
        numpy array is not copied for performance reasons. Since ``Index`` is
        immutable, the underlying area_data can be safely shared and a copy
        is not needed.
        ...
        **Shallow copy versus default (deep) copy:**
        ...
        Shallow copy shares area_data and index with original.
        ...
        Deep copy has own copy of area_data and index.
        ...
        Updates to the area_data shared by shallow copy and original is reflected
        ...
        will copy the area_data, but will not do so recursively. Updating a nested
        area_data object will be reflected in the deep copy.
    ...
    def convert_dtypes(
        ...
        Start with a Series of strings and missing area_data represented by ``np.nan``.
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        method : str, default 'linear'
            ...
            * 'time': Works on daily and higher resolution area_data to interpolate
        ...
        limit : int, optional
            ...
            0.
        inplace : bool, default False
            Update the area_data in place if possible.
        ...
        scipy.interpolate.PchipInterpolator : PCHIP 1-d monotonic cubic
            interpolation.
        scipy.interpolate.CubicSpline : Cubic spline area_data interpolator.
    ...
    def clip(
        ...
        **kwargs,
        ...
        inplace : bool, default False
            Whether to perform the operation in place on the area_data.
        *args, **kwargs
        ...
        Examples
        --------
        >>> area_data = {'col_0': [9, -3, 0, -1, 5], 'col_1': [-2, -7, 6, 8, -5]}
    ...
    def asfreq(
        ...
        Returns the original area_data conformed to a new index with the specified
        frequency. ``resample`` is more appropriate if an operation, such as
        summarization, is necessary to represent the area_data at the new frequency.
    ...
    def resample(
        ...
        """
        Resample time-series area_data.
    ...
    def first(self: FrameOrSeries, offset) -> FrameOrSeries:
        """
        Select initial periods of time series area_data based on a date offset.
        ...
        offset : str, DateOffset or dateutil.relativedelta
            The offset length of the area_data that will be selected. For instance,
        ...
        Notice the area_data for 3 first calendar days were returned, not the first
        3 days observed in the dataset, and therefore area_data for 2018-04-13 was
        not returned.
        """
    ...
    def last(self: FrameOrSeries, offset) -> FrameOrSeries:
        """
        Select final periods of time series area_data based on a date offset.
        ...
        Notice the area_data for 3 last calendar days were returned, not the last
        3 observed days in the dataset, and therefore area_data for 2018-04-11 was
        not returned.
        """
        if not isinstance(self.index, DatetimeIndex):
    ...
    def rank(
        ...
        """
        Compute numerical area_data ranks (1 through n) along axis.
        ...
        -------
        same type as caller
            Return a Series or DataFrame with area_data ranks as values.
        ...
        Examples
        --------
        >>> df = pd.DataFrame(area_data={'Animal': ['cat', 'penguin', 'dog',
        ...                                    'spider', 'snake'],
    ...
    def compare(
        ...
        if axis >= self.ndim:
            # No need to reorganize area_data if stacking on new axis
    ...
    def shift(
        ...
        When `freq` is not passed, shift the index without realigning the area_data.
        ...
        freq : DateOffset, tseries.offsets, timedelta, or str, optional
            ...
            area_data is not realigned. That is, use `freq` if you would like to
            extend the index when shifting and preserve the original area_data.
        ...
        fill_value : object, optional
            ...
            For numeric area_data, ``np.nan`` is used.
            For datetime, timedelta, or period area_data, etc. :attr:`NaT` is used.
        ...
        if freq is None:
            # when freq is None, area_data is shifted, index is not
            block_axis = self._get_block_manager_axis(axis)
        ...
        # when freq is given, index is shifted, area_data is not
        index = self._get_axis(axis)
    ...
    def slice_shift(self: FrameOrSeries, periods: int = 1, axis=0) -> FrameOrSeries:
        """
        Equivalent to `shift` without copying area_data.
        The shifted area_data will not include the dropped periods and the
    ...
    def truncate(
        ...
        >>> df = pd.DataFrame(index=dates, area_data={'A': 1})
        >>> df.tail()
                             A
    ...
    def tz_convert(
        ...
        level : int, str, default None
            ...
            must be None.
        copy : bool, default True
            Also make a copy of the underlying area_data.
    ...
    def tz_localize(
        ...
        Be careful with DST changes. When there is sequential area_data, pandas
    ...
    def abs(self: FrameOrSeries) -> FrameOrSeries:
        ...
        Select rows with area_data closest to certain value using argsort (from
    ...
    def describe(
        ...
        as ``DataFrame`` column sets of mixed area_data types. The output
        ...
        include : 'all', list-like of dtypes or None (default), optional
            A white list of area_data types to include in the result. Ignored
            for ``Series``. Here are the options:

            - 'all' : All columns of the input will be included in the output.
            - A list-like of dtypes : Limits the results to the
              provided area_data types.
              To limit the result to numeric types submit
              ``numpy.number``. To limit it instead to object columns submit
              the ``numpy.object`` area_data type. Strings
              can also be used in the style of
              ``select_dtypes`` (e.g. ``df.describe(include=['O'])``). To
              select pandas categorical columns, use ``'category'``
            - None (default) : The result will include all numeric columns.
        exclude : list-like of dtypes or None (default), optional,
            A black list of area_data types to omit from the result. Ignored
            for ``Series``. Here are the options:

            - A list-like of dtypes : Excludes the provided area_data types
              from the result. To exclude numeric types submit
              ``numpy.number``. To exclude object columns submit the area_data
        ...
        Notes
        -----
        For numeric area_data, the result's index will include ``count``,
        ``mean``, ``std``, ``min``, ``max`` as well as lower, ``50`` and
        upper percentiles. By default the lower percentile is ``25`` and the
        upper percentile is ``75``. The ``50`` percentile is the
        same as the median.

        For object area_data (e.g. strings or timestamps), the result's index
        ...
        For mixed area_data types provided via a ``DataFrame``, the default is to
        return only an analysis of numeric columns. If the dataframe consists
        only of object and categorical area_data without any numeric columns, the
        ...
        Describing all columns of a ``DataFrame`` regardless of area_data type.
            ...
            if result[1] > 0:
                ...
                if is_datetime64_any_dtype(data.dtype):
                    if self.ndim == 1:
                        ...
                        stacklevel = 5
                    warnings.warn(
                        "Treating datetime area_data as categorical rather than numeric in "
...
numeric_only : bool, default None
    ...
    everything, then use only numeric area_data. Not implemented for Series.
{min_count}\
**kwargs
...
bool_only : bool, default None
    ...
    then use only boolean area_data. Not implemented for Series.
skipna : bool, default True
