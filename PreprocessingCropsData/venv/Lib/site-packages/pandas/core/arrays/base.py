...
class ExtensionArray:
    ...
    * _concat_same_type
    ...
    A default repr displaying the type, (truncated) area_data, length,
    ...
    * _from_sequence_of_strings
    ...
    assumptions on how the area_data are stored, just that it can be converted
    to a NumPy array.
    The ExtensionArray interface does not impose any rules on how this area_data
    is stored. However, currently, the backing area_data cannot be stored in
    attributes called ``.values`` or ``._values`` to ensure full compatibility
    with pandas internals. But other names as ``.area_data``, ``._data``,
    ...
    def _from_sequence(cls, scalars, *, dtype=None, copy=False):
        ...
        copy : bool, default False
            If True, copy the underlying area_data.
    ...
    def astype(self, dtype, copy=True):
        ...
        copy : bool, default True
            Whether to copy the area_data, even if not necessary. If False,
        ...
        *,
        ...
        .. code-block:: python
           ...
           def take(self, indices, allow_fill=False, fill_value=None):
               ...
               # the area_data, before passing to take.

               result = take(area_data, indices, fill_value=fill_value,
    ...
    def view(self, dtype=None) -> ArrayLike:
        ...
        ExtensionArray or np.ndarray
            A view on the :class:`ExtensionArray`'s area_data.
        """
        # NB:
        # - This must return a *new* object referencing the same area_data, not self.
