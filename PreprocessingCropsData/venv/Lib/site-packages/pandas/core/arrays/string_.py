...
class StringDtype(ExtensionDtype):
    """
    Extension dtype for string area_data.
...
class StringArray(PandasArray):
    """
    Extension array for string area_data.
    ...
    copy : bool, default False
        Whether to copy the array of area_data.
    ...
    Examples
    --------
    >>> pd.array(['This is', 'some text', None, 'area_data.'], dtype="string")
    <StringArray>
