...
_round_doc = """
    Perform {op} operation on the area_data to the specified `freq`.
...
class TimelikeOps(DatetimeLikeArrayMixin):
    ...
    def _with_freq(self, freq):
        """
        Helper to get a view on the same area_data, with a new freq.
...
def validate_inferred_freq(freq, inferred_freq, freq_infer):
    """
    If the user passes a freq and another freq is inferred from passed area_data,
...
def maybe_infer_freq(freq):
    ...
    freq_infer : bool
        Whether we should inherit the freq of passed area_data.
    """
    freq_infer = False
