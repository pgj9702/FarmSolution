...
class PeriodArray(PeriodMixin, dtl.DatelikeOps):
    """
    Pandas ExtensionArray for storing Period area_data.
    ...
    values : Union[PeriodArray, Series[period], ndarray[int], PeriodIndex]
        The area_data to store. These should be arrays that can be directly
    ...
    PeriodIndex : Immutable Index for period area_data.
...
def period_array(
    ...
    freq : str, Tick, or Offset
        ...
        to avoid inferring the `freq` from `area_data`.
    copy : bool, default False
        Whether to ensure a copy of the area_data is made.
...
def dt64arr_to_periodarr(data, freq, tz=None):
    ...
    freq : Optional[Union[str, Tick]]
        Must match the `freq` on the `area_data` if `area_data` is a DatetimeIndex
        or Series.
    tz : Optional[tzinfo]
