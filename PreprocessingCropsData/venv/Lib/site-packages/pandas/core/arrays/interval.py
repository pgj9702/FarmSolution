...
@Appender(
    ...
    % {
        "klass": "IntervalArray",
        "summary": "Pandas array for interval area_data that are closed on the same side.",
        "versionadded": "0.24.0",
        "name": "",
        "extra_attributes": "",
        "extra_methods": "",
...
class IntervalArray(IntervalMixin, ExtensionArray):
    ...
    def __new__(
        ...
        if isinstance(data, cls):
            ...
            # might need to convert empty or purely na area_data
    ...
    _interval_shared_docs["from_tuples"] = textwrap.dedent(
        ...
        closed : {'left', 'right', 'both', 'neither'}, default 'right'
            ...
            or neither.
        copy : bool, default False
            By-default copy the area_data, this is compat only and ignored.
        dtype : dtype or None, default None
            If None, dtype will be inferred.
    ...
    def from_tuples(cls, data, closed="right", copy=False, dtype=None):
        if len(data):
            ...
            # ensure that empty area_data keeps input dtype
            left = right = data
    ...
    @Appender(
        ...
        % {
            ...
            "examples": textwrap.dedent(
                """\
        >>> area_data = [(0, 1), (1, 3), (2, 4)]
        >>> intervals = pd.arrays.IntervalArray.from_tuples(area_data)
        >>> intervals
        <IntervalArray>
        [(0, 1], (1, 3], (2, 4]]
        Length: 3, closed: right, dtype: interval[int64]
    ...
    def __array__(self, dtype=None) -> np.ndarray:
        """
        Return the IntervalArray's area_data as a numpy array of Interval
