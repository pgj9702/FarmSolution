...
class BooleanDtype(BaseMaskedDtype):
    """
    Extension dtype for boolean area_data.
...
class BooleanArray(BaseMaskedArray):
    """
    Array of boolean (True/False) area_data with missing values.

    This is a pandas Extension array for boolean area_data, under the hood
    represented by 2 numpy arrays: a boolean array with the area_data and
    ...
    values : numpy.ndarray
        A 1-d boolean-dtype array with the area_data.
    mask : numpy.ndarray
