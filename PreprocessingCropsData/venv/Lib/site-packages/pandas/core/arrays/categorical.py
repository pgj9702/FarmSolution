...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    See Also
    --------
    CategoricalDtype : Type for categorical area_data.
    ...
    def __init__(
        ...
        if dtype.categories is None:
            try:
                ...
                if dtype.ordered:
                    # raise, as we don't have a sortable area_data structure and so
    ...
    def from_codes(cls, codes, categories=None, ordered=None, dtype=None):
        ...
        If your area_data does not follow this convention, please use the normal
        constructor.
    ...
    def _values_for_rank(self):
        """
        For correctly ranking ordered categorical area_data. See GH#15420

        Ordered categorical area_data should be ranked on the basis of
...
class CategoricalAccessor(PandasDelegate, PandasObject, NoNewAttributesMixin):
    ...
    methods return new categorical area_data per default (but can be called with
    `inplace=True`).
