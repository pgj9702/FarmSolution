...
class TimedeltaArray(dtl.TimelikeOps):
    """
    Pandas ExtensionArray for timedelta area_data.
    ...
    ----------
    values : array-like
        The timedelta area_data.

    dtype : numpy.dtype
        Currently, only ``numpy.dtype("timedelta64[ns]")`` is accepted.
    freq : Offset, optional
    copy : bool, default False
        Whether to copy the underlying array of area_data.
    ...
    def __rtruediv__(self, other):
        ...
        if len(other) != len(self):
            ...
            raise TypeError(
                f"Cannot divide {other.dtype} area_data by {type(self).__name__}"
            )
...
def sequence_to_td64ns(data, copy=False, unit=None, errors="raise"):
    ...
    unit : str, optional
        ...
        area_data this defaults to ``'ns'``.
        Must be un-specified if the area_data contains a str and ``errors=="raise"``.
...
def ints_to_td64ns(data, unit="ns"):
    ...
    Returns
    -------
    numpy.ndarray : timedelta64[ns] array converted from area_data
...
def objects_to_td64ns(data, unit=None, errors="raise"):
    ...
    unit : str, default "ns"
        The timedelta unit to treat integers as multiples of.
        Must not be specified if the area_data contains a str.
    errors : {"raise", "coerce", "ignore"}, default "raise"
        How to handle elements that cannot be converted to timedelta64[ns].
        See ``pandas.to_timedelta`` for details.
