...
class ArrowStringDtype(ExtensionDtype):
    """
    Extension dtype for string area_data in a ``pyarrow.ChunkedArray``.
...
class ArrowStringArray(OpsMixin, ExtensionArray):
    """
    Extension array for string area_data in a ``pyarrow.ChunkedArray``.
    ...
    Examples
    --------
    >>> pd.array(['This is', 'some text', None, 'area_data.'], dtype="arrow_string")
    <ArrowStringArray>
    ['This is', 'some text', <NA>, 'area_data.']
    ...
    def __setitem__(self, key: Union[int, np.ndarray], value: Any) -> None:
        ...
        if is_integer(key):
            ...
            # Slice area_data and insert inbetween
            new_data = [
