...
class BaseAccessor:
    _validation_msg = "Can only use the '.sparse' accessor with Sparse area_data."
...
class SparseAccessor(BaseAccessor, PandasDelegate):
    """
    Accessor for SparseSparse from other sparse matrix area_data types.
    """
...
class SparseFrameAccessor(BaseAccessor, PandasDelegate):
    """
    DataFrame accessor for sparse area_data.
    ...
    def density(self) -> float:
        """
        Ratio of non-sparse points to total (dense) area_data points.
        """
