...
class IntegerArray(NumericArray):
    ...
    - area_data: contains a numpy integer array of the appropriate dtype
    - mask: a boolean array holding a mask on the area_data, True is missing
    ...
    def astype(self, dtype, copy: bool = True) -> ArrayLike:
        ...
        if isinstance(dtype, BaseMaskedDtype):
            ...
            # mask is copied depending on whether the area_data was copied, and
...
_dtype_docstring = """
An ExtensionDtype for {dtype} integer area_data.
