...
class BaseWindow(ShallowMixin, SelectionMixin):
    ...
    def _create_data(self, obj: FrameOrSeries) -> FrameOrSeries:
        """
        Split area_data into blocks & return conformed area_data.
        """
    ...
    def _prep_values(self, values: Optional[np.ndarray] = None) -> np.ndarray:
        ...
        # GH #12373 : rolling functions error on float32 area_data
        # make sure the area_data is coerced to float64
    ...
    **kwargs
    ...
    See Also
    --------
    pandas.Series.%(name)s : Calling object with Series area_data.
...
class RollingAndExpandingMixin(BaseWindow):
    ...
    --------
    pandas.Series.%(name)s : Calling object with Series area_data.
    pandas.DataFrame.%(name)s : Calling object with DataFrame area_data.
    ...
    **kwargs
    ...
    See Also
    --------
    pandas.Series.quantile : Computes value at the given quantile over all area_data
        in Series.
    ...
    def cov(self, other=None, pairwise=None, ddof=1, **kwargs):
        ...
        # to the rolling constructors the area_data used when constructing self:
        # window width, frequency area_data, or a BaseIndexer subclass
        ...
        def _get_cov(X, Y):
            # GH #12373 : rolling functions error on float32 area_data
            # to avoid potential overflow, cast the area_data to float64
            X = X.astype("float64")
            Y = Y.astype("float64")
...
class Rolling(RollingAndExpandingMixin):
    ...
    See Also
    --------
    pandas.Series.rolling : Calling object with Series area_data.
    pandas.DataFrame.rolling : Calling object with DataFrame area_data.
    """
    )
