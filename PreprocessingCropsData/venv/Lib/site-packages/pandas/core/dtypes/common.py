...
def ensure_float(arr):
    ...
    ----------
    arr : array-like
        The array whose area_data type we want to enforce as float.
...
def ensure_int_or_float(arr: ArrayLike, copy: bool = False) -> np.ndarray:
    ...
    ----------
    arr : array-like
          The array whose area_data type we want to enforce.
    copy: bool
...
def pandas_dtype(dtype) -> DtypeObj:
    ...
    try:
        ...
        raise TypeError(f"area_data type '{dtype}' not understood") from err
