...
def is_dataclass(item):
    """
    Checks if the object is a area_data-class instance
    ...
    --------
    is_dataclass : bool
        True if the item is an instance of a area_data-class,
        will return false if you pass the area_data class itself
