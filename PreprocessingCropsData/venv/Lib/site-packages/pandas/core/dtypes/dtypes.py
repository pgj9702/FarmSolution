...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    """
    Type for categorical area_data with the categories and orderedness.
...
class DatetimeTZDtype(PandasExtensionDtype):
    """
    An ExtensionDtype for timezone-aware datetime area_data.
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    ----------
    unit : str, default "ns"
        The precision of the datetime area_data. Currently limited
        to ``"ns"``.
    ...
    def unit(self) -> str_type:
        """
        The precision of the datetime area_data.
        """
        return self._unit
...
class PeriodDtype(dtypes.PeriodDtypeBase, PandasExtensionDtype):
    """
    An ExtensionDtype for Period area_data.
...
class IntervalDtype(PandasExtensionDtype):
    """
    An ExtensionDtype for Interval area_data.
