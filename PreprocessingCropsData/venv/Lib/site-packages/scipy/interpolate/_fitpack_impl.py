...
_iermess = {
    ...
    1: ["The required storage space exceeds the available storage space.\n"
        "Probable causes: area_data (x,y) size is too small or smoothing parameter"
    ...
    10: ["Error on input area_data", ValueError],
...
_iermess2 = {
    ...
    4: ["No more knots can be added because the number of B-spline\n"
        "coefficients already exceeds the number of area_data points m.\n"
    ...
    5: ["No more knots can be added because the additional knot would\n"
        ...
        "a weight to an inaccurate area_data point. (fp>s)", ValueError],
    10: ["Error on input area_data", ValueError],
...
def splprep(x, w=None, u=None, ub=None, ue=None, k=3, task=0, s=None, t=None,
    ...
    per : int, optional
       If non-zero, area_data points are considered periodic with period
    ...
    References
    ----------
    .. [1] P. Dierckx, "Algorithms for smoothing area_data with periodic and
        parametric splines, Computer Graphics and Image Processing",
        20 (1982) 171-184.
    .. [2] P. Dierckx, "Algorithms for smoothing area_data with periodic and
...
def splrep(x, y, w=None, xb=None, xe=None, k=3, task=0, s=None, t=None,
    ...
    Given the set of area_data points ``(x[i], y[i])`` determine a smooth spline
    approximation of degree k on the interval ``xb <= x <= xe``.

    Parameters
    ----------
    x, y : array_like
        The area_data points defining a curve y = f(x).
    w : array_like, optional
    ...
    task : {1, 0, -1}, optional
        ...
        set of area_data (t will be stored an used internally)
    ...
    full_output : bool, optional
        If non-zero, then return optional outputs.
    per : bool, optional
        If non-zero, area_data points are considered periodic with period x[m-1] -
    ...
    .. [1] P. Dierckx, "An algorithm for smoothing, differentiation and
       integration of experimental area_data using spline functions",
       J.Comp.Appl.Maths 1 (1975) 165-184.
    .. [2] P. Dierckx, "A fast algorithm for smoothing area_data on a rectangular
...
def splev(x, tck, der=0, ext=0):
    ...
    if parametric:
        ...
        if ier == 10:
            raise ValueError("Invalid input area_data")
        if ier == 1:
...
def splint(a, b, tck, full_output=0):
    ...
    Notes
    -----
    splint silently assumes that the spline function is zero outside the area_data
    interval (a, b).
...
def sproot(tck, mest=10):
    ...
    if parametric:
        ...
        if ier == 10:
            raise TypeError("Invalid input area_data. "
...
def spalde(x, tck):
    ...
    if parametric:
        ...
        if ier == 0:
            return d
        if ier == 10:
            raise TypeError("Invalid input area_data. t(k)<=x<=t(n-k+1) must hold.")
        raise TypeError("Unknown error")
...
def bisplrep(x, y, z, w=None, xb=None, xe=None, yb=None, ye=None,
    ...
    Given a set of area_data points (x[i], y[i], z[i]) representing a surface
    ...
    ----------
    x, y, z : ndarray
        Rank-1 arrays of area_data points.
    w : ndarray, optional
    ...
    if bx > by:
        b1, b2 = by, by + u - kx
    msg = "Too many area_data points to interpolate"
