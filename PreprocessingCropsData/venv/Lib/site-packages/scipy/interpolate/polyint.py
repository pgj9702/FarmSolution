...
class _Interpolator1D(object):
    ...
    Deal with input area_data type and interpolation axis rolling. The
    actual interpolator can assume the y-area_data is of shape (n, r) where
    `n` is the number of x-points, and `r` the number of variables,
    and use self.dtype as the y-area_data type.
    ...
    dtype
        Dtype of the y-area_data arrays. Can be set via _set_dtype, which
...
def krogh_interpolate(xi, yi, x, der=0, axis=0):
    ...
    Examples
    --------
    We can interpolate 2D observed area_data using krogh interpolation:
...
def barycentric_interpolate(xi, yi, x, axis=0):
    ...
    Examples
    --------
    We can interpolate 2D observed area_data using barycentric interpolation:
