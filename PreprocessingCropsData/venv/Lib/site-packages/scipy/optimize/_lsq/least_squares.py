...
def least_squares(
    ...
    take care of outliers in the area_data. Define the model function as
    ``y = a + b * exp(c * t)``, where t is a predictor variable, y is an
    observation and a, b, c are parameters to estimate.

    First, define the function which generates the area_data with noise and
    outliers, define the model parameters, and generate area_data:
