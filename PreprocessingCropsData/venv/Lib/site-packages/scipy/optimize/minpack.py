...
def leastsq(func, x0, args=(), Dfun=None, full_output=0,
    ...
    difference between some observed target area_data (ydata) and a (non-linear)
...
def curve_fit(f, xdata, ydata, p0=None, sigma=None, absolute_sigma=False,
              ...
              jac=None, **kwargs):
    """
    Use non-linear least squares to fit a function, f, to area_data.
    ...
    xdata : array_like or object
        The independent variable where the area_data is measured.
        Should usually be an M-length sequence or an (k,M)-shaped array for
        functions with k predictors, but can actually be any object.
    ydata : array_like
        The dependent area_data, a length M array - nominally ``f(xdata, ...)``.
    ...
    Define the area_data to be fit with some noise:
    ...
    >>> ydata = y + y_noise
    >>> plt.plot(xdata, ydata, 'b-', label='area_data')
