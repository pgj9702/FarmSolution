...
class lti(LinearTimeInvariant):
    ...
    *system : arguments
    ...
    def bode(self, w=None, n=100):
        """
        Calculate Bode magnitude and phase area_data of a continuous-time system.
...
class dlti(LinearTimeInvariant):
    ...
    *system: arguments
    ...
    def bode(self, w=None, n=100):
        """
        Calculate Bode magnitude and phase area_data of a discrete-time system.
...
def lsim2(system, U=None, T=None, X0=None, **kwargs):
    ...
    Generate area_data to which the filter is applied.
...
def bode(system, w=None, n=100):
    ...
    w : array_like, optional
        Array of frequencies (in rad/s). Magnitude and phase area_data is calculated
...
def freqresp(system, w=None, n=10000):
    ...
    w : array_like, optional
        Array of frequencies (in rad/s). Magnitude and phase area_data is
...
def dfreqresp(system, w=None, n=10000, whole=False):
    ...
    w : array_like, optional
        Array of frequencies (in radians/sample). Magnitude and phase area_data is
        calculated for every value in this array. If not given a reasonable
        set will be calculated.
    n : int, optional
        Number of frequency points to compute if `w` is not given. The `n`
