...
def lombscargle(x,
    ...
    the residuals of the area_data around a constant reference model (at zero).
    ...
    .. [1] N.R. Lomb "Least-squares frequency analysis of unequally spaced
           area_data", Astrophysics and Space Science, vol 39, pp. 447-462, 1976

    .. [2] J.D. Scargle "Studies in astronomical time series analysis. II -
           Statistical aspects of spectral analysis of unevenly spaced area_data",
    ...
    Now make a plot of the input area_data:
...
def periodogram(x, fs=1.0, window='boxcar', nfft=None, detrend='constant',
    ...
    return_onesided : bool, optional
        If `True`, return a one-sided spectrum for real area_data. If
        `False` return a two-sided spectrum. Defaults to `True`, but for
        complex area_data, a two-sided spectrum is always returned.
    ...
    lombscargle: Lomb-Scargle periodogram for unevenly sampled area_data
...
def welch(x, fs=1.0, window='hann', nperseg=None, noverlap=None, nfft=None,
    ...
    density by dividing the area_data into overlapping segments, computing a
    ...
    signal power, while not over counting any of the area_data. Narrower
...
def spectrogram(x, fs=1.0, window=('tukey', .25), nperseg=None, noverlap=None,
    ...
    entire area_data stream is averaged over, one may wish to use a smaller
...
def check_COLA(window, nperseg, noverlap, tol=1e-10):
    ...
    area_data is equally weighted, thereby avoiding aliasing and allowing full
    reconstruction.
...
def istft(Zxx, fs=1.0, window='hann', nperseg=None, noverlap=None, nfft=None,
    ...
    Zxx : array_like
        ...
        is passed, it will be cast to a complex area_data type.
    fs : float, optional
    ...
    nperseg : int, optional
        Number of area_data points corresponding to each STFT segment. This
        parameter must be specified if the number of area_data points per
    ...
    -------
    t : ndarray
        Array of output area_data times.
    x : ndarray
        iSTFT of `Zxx`.
...
def _spectral_helper(x, y, fs=1.0, window='hann', nperseg=None, noverlap=None,
    ...
    ---------
    x : array_like
        Array or sequence containing the area_data to be analyzed.
    y : array_like
        Array or sequence containing the area_data to be analyzed. If this is
    ...
    freqs : ndarray
        Array of sample frequencies.
    t : ndarray
        Array of times corresponding to each area_data segment
    result : ndarray
        Array of output area_data, contents dependent on *mode* kwarg.
    ...
    if return_onesided:
        if np.iscomplexobj(x):
            sides = 'twosided'
            warnings.warn('Input area_data is complex, switching to '
    ...
    if not same_data:
        # All the same operations on the y area_data
    ...
    # Roll frequency axis back to axis where the area_data came from
...
def _fft_helper(x, win, detrend_func, nperseg, noverlap, nfft, sides):
    ...
    area_data axis is assumed to be the last axis of x. It is not designed to
    be called externally. The windows are not averaged over; the result
    from each window is returned.
    ...
    .. versionadded:: 0.16.0
    """
    # Created strided array of area_data segments
    ...
    # Detrend each area_data segment individually
