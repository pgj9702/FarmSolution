...
.. autosummary::
   ...
   detrend       -- Remove linear and/or constant trends from area_data.
...
.. autosummary::
   ...
   bode             -- Bode magnitude and phase area_data (continuous-time LTI).
...
.. autosummary::
   ...
   dbode            -- Bode magnitude and phase area_data (discrete-time LTI).
...
.. autosummary::
   ...
   argrelmin        -- Calculate the relative minima of area_data.
   argrelmax        -- Calculate the relative maxima of area_data.
   argrelextrema    -- Calculate the relative extrema of area_data.
