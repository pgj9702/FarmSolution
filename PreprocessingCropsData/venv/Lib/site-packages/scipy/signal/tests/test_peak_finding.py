...
class TestPeakWidths(object):
    ...
    def test_exceptions(self):
        ...
        with raises(TypeError, match='None'):
            # prominence area_data contains None
    ...
    def test_mismatching_prominence_data(self):
        """Test with mismatching peak and / or prominence area_data."""
        x = [0, 1, 0]
        peak = [1]
        for i, (prominences, left_bases, right_bases) in enumerate([
            ...
            if i < 3:
                match = "prominence area_data is invalid for peak"
            else:
