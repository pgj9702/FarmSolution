...
def fixed_quad(func, a, b, args=(), n=5):
    ...
    romb : integrators for sampled area_data
    simpson : integrators for sampled area_data
    cumulative_trapezoid : cumulative integration for sampled area_data
    ode : ODE integrator
...
def quadrature(func, a, b, args=(), tol=1.49e-8, rtol=1.49e-8, maxiter=50,
    ...
    dblquad: double integrals
    tplquad: triple integrals
    romb: integrator for sampled area_data
    simpson: integrator for sampled area_data
    cumulative_trapezoid: cumulative integration for sampled area_data
    ode: ODE integrator
    odeint: ODE integrator
...
#  for equally spaced area_data using the commands
...
def newton_cotes(rn, equal=0):
    ...
    ----------
    rn : int
        The integer order for equally-spaced area_data or the relative positions of
        the samples with the first sample at 0 and the last at N, where N+1 is
        the length of `rn`. N is the order of the Newton-Cotes integration.
    equal : int, optional
        Set to 1 to enforce equally spaced area_data.
