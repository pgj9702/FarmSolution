...
=========================
ARFF is the standard area_data format for WEKA.
It is a text file format which support numerical, string and area_data values.
The format can also represent missing area_data and sparse area_data.
