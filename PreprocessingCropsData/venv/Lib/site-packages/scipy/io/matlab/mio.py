...
def loadmat(file_name, mdict=None, appendmat=True, **kwargs):
    ...
    Get the filename for an example .mat file from the tests/area_data directory.

    >>> data_dir = pjoin(dirname(sio.__file__), 'matlab', 'tests', 'area_data')
...
def whosmat(file_name, appendmat=True, **kwargs):
    ...
    variables : list of tuples
        ...
        its shape (tuple of ints), and its area_data class (a string).
        Possible area_data classes are: int8, uint8, int16, uint16, int32, uint32,
