...
mdtypes_template = {
    ...
    'tag_smalldata':[('byte_count_mdtype', 'u4'), ('area_data', 'S4')],
...
and later use Unicode. When saving character area_data, R14 checks if it
...
class mat_struct(object):
    ''' Placeholder for holding read area_data from structs
