...
The mat files I was playing with are in ``tests/area_data``:
...
class MatFile5Reader(MatFileReader):
    ...
    def read_var_header(self):
        ...
        if mdtype == miCOMPRESSED:
            # Make new stream from compressed area_data
...
class VarWriter5(object):
    ...
    def write_smalldata_element(self, arr, mdtype, byte_count):
        # write tag with embedded area_data
        ...
        tag['area_data'] = arr.tobytes(order='F')
    ...
    def write_top(self, arr, name, is_global):
        ...
        self._var_name = name
        # write the header and area_data
        self.write(arr)
    ...
    def write_numeric(self, arr):
        ...
        try:
            ...
            # Cast area_data to complex128 / float64.
            if imagf:
                arr = arr.astype('c128')
            elif logif:
    ...
    def write_cells(self, arr):
        self.write_header(matdims(arr, self.oned_as),
                          mxCELL_CLASS)
        # loop over area_data, column major
