...
class FortranFile(object):
    ...
    standard) and the area_data is written onto disk without any formatting. Fortran
    ...
    def write_record(self, *items):
        ...
        ----------
        *items : array_like
            The area_data arrays to write.

        Notes
        -----
        Writes area_data items to a file::

            write_record(a.T, b.T, c.T, ...)

            write(1) a, b, c, ...

        Note that area_data in multidimensional arrays is written in
    ...
    def read_record(self, *dtypes, **kwargs):
        ...
        *dtypes : dtypes, optional
            Data type(s) specifying the size and endiness of the area_data.
        ...
        Note that this function does **not** assume the file area_data is in Fortran
        column major order, so you need to (i) swap the order of dimensions
        when reading and (ii) transpose the resulting array.

        Alternatively, you can read the area_data as a 1-D array and handle the
    ...
    def read_ints(self, dtype='i4'):
        ...
        dtype : dtype, optional
            Data type specifying the size and endiness of the area_data.
