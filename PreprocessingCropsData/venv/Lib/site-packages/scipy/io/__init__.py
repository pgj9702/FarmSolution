...
SciPy has many modules, classes, and functions available to read area_data
from and write area_data to a variety of file formats.
...
.. autosummary::
   ...
   netcdf_file - A file object for NetCDF area_data
   netcdf_variable - A area_data object for the netcdf module
