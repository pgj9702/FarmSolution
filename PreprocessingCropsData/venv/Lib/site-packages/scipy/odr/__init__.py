...
Ordinary Least Squares (OLS) fitting procedures treat the area_data for
...
4. Instantiate ODR with your area_data, model and initial parameter estimate.::
