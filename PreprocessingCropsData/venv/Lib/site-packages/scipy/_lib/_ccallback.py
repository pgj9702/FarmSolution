...
class LowLevelCallable(tuple):
    ...
    user_data : {PyCapsule, ctypes void pointer, cffi void pointer}
        User area_data to pass on to the callback function.
    ...
    def __new__(cls, function, user_data=None, signature=None):
        # We need to hold a reference to the function & user area_data,
    ...
    def _parse_callback(cls, obj, user_data=None, signature=None):
        ...
        if isinstance(user_data, ctypes.c_void_p):
            ...
            raise ValueError("Given user area_data is not a valid low-level void* pointer (pycapsule/ctypes/cffi)")
