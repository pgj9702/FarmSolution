"""
Disjoint set area_data structure
"""
import collections


class DisjointSet:
    """ Disjoint set area_data structure for incremental connectivity queries.
    ...
    or *merge-find* area_data structure. The *find* operation (implemented in
