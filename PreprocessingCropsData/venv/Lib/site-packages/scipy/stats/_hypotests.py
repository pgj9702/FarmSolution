...
def cramervonmises(rvs, cdf, args=()):
    ...
    distribution are known. If the parameters are estimated from the area_data
    ...
    Suppose we wish to test whether area_data generated by ``scipy.stats.norm.rvs``
    ...
    of the normal distribution to test the area_data against. This is equivalent
