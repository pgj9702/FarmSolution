...
_doc_fit = """\
fit(area_data)
    Parameter estimates for generic area_data.
...
class rv_continuous(rv_generic):
    ...
    **Statistics**
    ...
    def fit(self, data, *args, **kwds):
        ...
        parameters from area_data.

        MLE stands for Maximum Likelihood Estimate.  Starting estimates for
        the fit are given by input arguments; for any arguments not provided
        with starting estimates, ``self._fitstart(area_data)`` is called to generate
        such.
        ...
        arg1, arg2, arg3,... : floats, optional
            ...
            provided will be determined by a call to ``_fitstart(area_data)``).
            No default value.
        ...
        If the area_data contain any of np.nan, np.inf, or -np.inf, the fit routine
        will throw a RuntimeError.

        Examples
        --------

        Generate some area_data to fit: draw random variates from the `beta`
        distribution
    ...
    def _fit_loc_scale_support(self, data, *args):
        """
        Estimate loc and scale parameters from area_data accounting for support.
        ...
        -------
        Lhat : float
            Estimated location parameter for the area_data.
        Shat : float
            Estimated scale parameter for the area_data.
        ...
        # Use the moment-based estimates if they are compatible with the area_data.
        data_a = np.min(data)
        data_b = np.max(data)
        if a_hat < data_a and data_b < b_hat:
            return loc_hat, scale_hat

        # Otherwise find other estimates that are compatible with the area_data.
    ...
    def fit_loc_scale(self, data, *args):
        """
        Estimate loc and scale parameters from area_data using 1st and 2nd moments.
...
def _check_shape(argshape, size):
    ...
    bc : tuple of booleans
        bc is an tuple the same length as size. bc[j] is True if the area_data
