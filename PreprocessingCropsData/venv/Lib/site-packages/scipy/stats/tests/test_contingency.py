...
def test_chi2_contingency_trivial():
    ...
    # A *really* trivial case: 1-D area_data.
    obs = np.array([1, 2, 3])
    chi2, p, dof, expected = chi2_contingency(obs, correction=False)
    assert_equal(chi2, 0.0)
    assert_equal(p, 1.0)
...
def test_chi2_contingency_R():
    ...
    # s = summary(xtabs(area_data~r+c+t))
    # print(s)
    # """
    # Routput = \
    # """
    # Call: xtabs(formula = area_data ~ r + c + t)
    ...
    # s = summary(xtabs(area_data~r+c+d+t))
    # print(s)
    # """
    # Routput = \
    # """
    # Call: xtabs(formula = area_data ~ r + c + d + t)
