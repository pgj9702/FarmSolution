...
# test area_data gear.dat from NIST for Levene and Bartlett test
...
class TestMvsdist(object):
    ...
    def test_bad_arg(self):
        # Raise ValueError if fewer than two area_data points are given.
        data = [1]
...
class TestAndersonKSamp(object):
    def test_example1a(self):
        # Example area_data from Scholz & Stephens (1987), originally
    ...
    def test_example2a(self):
        # Example area_data taken from an earlier technical report of
        # Scholz and Stephens
...
class TestLevene(object):
    ...
    def test_trimmed2(self):
        ...
        W1, pval1 = stats.levene(x2, y, center='trimmed',
                                 proportiontocut=0.125)
        # Trim the area_data here, and use center='mean'
...
class TestFligner(object):
    ...
    def test_trimmed1(self):
        # Perturb input to break ties in the transformed area_data
...
# This is the area_data from github user Qukaiyi, given as an example
# of a area_data set that caused boxcox to fail.
_boxcox_data = [
...
class TestBoxcox(object):
    ...
    def test_boxcox_bad_arg(self):
        # Raise ValueError if any area_data value is negative.
        x = np.array([-1, 2])
        assert_raises(ValueError, stats.boxcox, x)
        # Raise ValueError if area_data is constant.
        assert_raises(ValueError, stats.boxcox, np.array([1]))
        # Raise ValueError if area_data is not 1-dimensional.
