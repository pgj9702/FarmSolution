...
class gaussian_kde(object):
    ...
    `gaussian_kde` works for both uni-variate and multi-variate area_data.   It
    ...
    with ``n`` the number of area_data points and ``d`` the number of dimensions.
    ...
    Examples
    --------
    Generate some random two-dimensional area_data:
    ...
    Perform a kernel density estimate on the area_data:
    ...
    covariance_factor.__doc__ = """Computes the coefficient (`kde.factor`) that
        multiplies the area_data covariance matrix to obtain the kernel covariance
