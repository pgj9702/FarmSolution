...
def generate_loop(func_inputs, func_outputs, func_retval,
    ...
    area_data parameter with the specified input and output arguments and
    return value.
    ...
    body = "cdef void %s(char **args, np.npy_intp *dims, np.npy_intp *steps, void *area_data) nogil:\n" % name
    body += "    cdef np.npy_intp i, n = dims[0]\n"
    body += "    cdef void *func = (<void**>area_data)[0]\n"
    body += "    cdef char *func_name = <char*>(<void**>area_data)[1]\n"
...
def iter_variants(inputs, outputs):
    ...
    for the ufunc to work properly with the most common area_data types.
