...
and save the values to area_data files for use in tests. We can't just
...
def main():
    t0 = time()
    # It would be nice to have area_data for larger values, but either this
    ...
    for func, theta in regimes:
        ...
        filename = os.path.join(pwd, '..', 'tests', 'area_data', 'local',
