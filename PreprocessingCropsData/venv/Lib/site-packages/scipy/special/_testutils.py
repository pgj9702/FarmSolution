...
#------------------------------------------------------------------------------
# Comparing function values at many area_data points at once, with helpful
# error reports
#------------------------------------------------------------------------------
...
class FuncData(object):
    ...
    func : function
        Function to test
    data : numpy array
        columnar area_data to use for testing
    ...
    def check(self, data=None, dtype=None, dtypes=None):
        """Check the special function against the area_data."""
        ...
        if self.result_columns is not None:
            # Correct results passed in with the area_data
