...
def cho_factor(a, lower=False, overwrite_a=False, check_finite=True):
    ...
    .. warning::
        The returned matrix also contains random area_data in the entries not
    ...
    c : (M, M) ndarray
        ...
        of `a`. Other parts of the matrix contain random area_data.
    lower : bool
...
def cho_solve(c_and_lower, b, overwrite_b=False, check_finite=True):
    ...
    overwrite_b : bool, optional
        Whether to overwrite area_data in b (may improve performance)
    check_finite : bool, optional
