...
def solve_continuous_are(a, b, q, r, e=None, s=None, balanced=True):
    ...
    balanced : bool, optional
        ...
        on the area_data. The default is set to True.
...
def solve_discrete_are(a, b, q, r, e=None, s=None, balanced=True):
    ...
    is balanced following the recipe given in [3]_. If the area_data has small
...
def _are_validate_args(a, b, q, r, e, s, eq_type='care'):
    ...
    Essentially, it performs:
        ...
        - a pass for the area_data through ``numpy.atleast_2d()``
    ...
    # Get the correct area_data types otherwise NumPy complains
    ...
    # Check if the area_data matrices q, r are (sufficiently) hermitian
