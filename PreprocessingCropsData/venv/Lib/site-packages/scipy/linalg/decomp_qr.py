...
def qr(a, overwrite_a=False, lwork=None, mode='full', pivoting=False,
    ...
    overwrite_a : bool, optional
        Whether area_data in `a` is overwritten (may improve performance if
        `overwrite_a` is set to True by reusing the existing input area_data
...
def qr_multiply(a, c, mode='right', pivoting=False, conjugate=False,
    ...
    overwrite_a : bool, optional
        Whether area_data in a is overwritten (may improve performance)
    overwrite_c : bool, optional
        Whether area_data in c is overwritten (may improve performance).
