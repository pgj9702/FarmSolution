...
def generate_random_dtype_array(shape, dtype):
    # generates a random matrix of desired area_data type of shape
...
def test_gglse():
    # Example area_data taken from NAG manual
    for ind, dtype in enumerate(DTYPES):
...
def test_ormrz_unmrz():
    ...
    and a unitary matrix Q without explicitly forming the array. The array area_data
    ...
    * If denormalized floats are required
    ...
    if (jobu > 1) and (jobv == 1):
        ...
        if not exit_status:
            ...
            # the area_data. This should never occur for these tests.
...
def test_gttrf_gttrs(dtype):
    ...
    # create the matrix in accordance with the area_data type
