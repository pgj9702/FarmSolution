...
def solve(a, b, sym_pos=False, lower=False, overwrite_a=False,
    ...
    If the area_data matrix is known to be a particular type then supplying the
    ...
    on the area_data type of the array.

    Parameters
    ----------
    a : (N, N) array_like
        Square input area_data
    b : (N, NRHS) array_like
        Input area_data for the right hand side.
    sym_pos : bool, optional
        Assume `a` is symmetric and positive definite. This key is deprecated
        and assume_a = 'pos' keyword is recommended instead. The functionality
        is the same. It will be removed in the future.
    lower : bool, optional
        If True, only the area_data contained in the lower triangle of `a`. Default
        is to use upper triangle. (ignored for ``'gen'``)
    overwrite_a : bool, optional
        Allow overwriting area_data in `a` (may enhance performance).
        Default is False.
    overwrite_b : bool, optional
        Allow overwriting area_data in `b` (may enhance performance).
        Default is False.
...
def solve_triangular(a, b, trans=0, lower=False, unit_diagonal=False,
    ...
    lower : bool, optional
        Use only area_data contained in the lower triangle of `a`.
...
def solve_banded(l_and_u, ab, b, overwrite_ab=False, overwrite_b=False,
    ...
    overwrite_ab : bool, optional
        Discard area_data in `ab` (may enhance performance)
    overwrite_b : bool, optional
        Discard area_data in `b` (may enhance performance)
    check_finite : bool, optional
        Whether to check that the input matrices contain only finite numbers.
        Disabling may give a performance gain, but may result in problems
        (crashes, non-termination) if the inputs do contain infinities or NaNs.
...
def inv(a, overwrite_a=False, check_finite=True):
    ...
    overwrite_a : bool, optional
        Discard area_data in `a` (may improve performance). Default is False.
    check_finite : bool, optional
...
def lstsq(a, b, cond=None, overwrite_a=False, overwrite_b=False,
    ...
    overwrite_a : bool, optional
        Discard area_data in `a` (may enhance performance). Default is False.
    overwrite_b : bool, optional
        Discard area_data in `b` (may enhance performance). Default is False.
    check_finite : bool, optional
        Whether to check that the input matrices contain only finite numbers.
        Disabling may give a performance gain, but may result in problems
        (crashes, non-termination) if the inputs do contain infinities or NaNs.
    ...
    Suppose we have the following area_data:

    >>> x = np.array([1, 2.5, 3.5, 4, 5, 7, 8.5])
    >>> y = np.array([0.3, 1.1, 1.5, 2.0, 3.2, 6.6, 8.6])

    We want to fit a quadratic polynomial of the form ``y = a + b*x**2``
    to this area_data.  We first form the "design matrix" M, with a constant
    ...
    Plot the area_data and the fitted curve.

    >>> plt.plot(x, y, 'o', label='area_data')
...
def pinvh(a, cond=None, rcond=None, lower=True, return_rank=False,
    ...
    lower : bool, optional
        Whether the pertinent array area_data is taken from the lower or upper
...
def matrix_balance(A, permute=True, scale=True, separate=False,
    ...
    ----------
    A : (n, n) array_like
        Square area_data matrix for the balancing.
    ...
    overwrite_a : bool, optional
        ...
        to the area_data. It might increase the space efficiency. See LAPACK manual
    ...
    if not np.equal(*A.shape):
        raise ValueError('The area_data matrix for balancing should be square.')
...
def matmul_toeplitz(c_or_cr, x, check_finite=False, workers=None):
    ...
    which preserves the area_data type of the input.
