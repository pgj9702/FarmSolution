...
def eigh(a, b=None, lower=True, eigvals_only=False, overwrite_a=False,
    ...
    overwrite_a : bool, optional
        Whether to overwrite area_data in ``a`` (may improve performance). Default
        is False.
    overwrite_b : bool, optional
        Whether to overwrite area_data in ``b`` (may improve performance). Default
        is False.
    check_finite : bool, optional
        Whether to check that the input matrices contain only finite numbers.
        Disabling may give a performance gain, but may result in problems
...
def eig_banded(a_band, lower=False, eigvals_only=False, overwrite_a_band=False,
    ...
    overwrite_a_band : bool, optional
        Discard area_data in a_band (may enhance performance)
...
def eigvals(a, b=None, overwrite_a=False, check_finite=True,
    ...
    b : (M, M) array_like, optional
        ...
        If omitted, identity matrix is assumed.
    overwrite_a : bool, optional
        Whether to overwrite area_data in a (may improve performance)
    check_finite : bool, optional
        Whether to check that the input matrices contain only finite numbers.
        Disabling may give a performance gain, but may result in problems
