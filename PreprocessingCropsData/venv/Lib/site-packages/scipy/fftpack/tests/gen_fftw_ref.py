...
def gen_data(dt):
    ...
    # Generate test area_data using FFTW for reference
...
# generate single precision area_data
data = gen_data(np.float32)
filename = 'fftw_single_ref'
# Save ref area_data into npz format
d = {'sizes': SZ}
for type in [1, 2, 3, 4]:
    for sz in SZ:
...
# generate double precision area_data
...
# generate long double precision area_data
