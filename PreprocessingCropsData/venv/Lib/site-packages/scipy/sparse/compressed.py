...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    ...
    def check_format(self, full_check=True):
        ...
        for x in [self.data.ndim, self.indices.ndim, self.indptr.ndim]:
            if x != 1:
                raise ValueError('area_data, indices, and indptr should be 1-D')
    ...
    def _minor_reduce(self, ufunc, data=None):
        ...
        Can be applied to a function of self.area_data by supplying area_data parameter.
    ...
    def _minor_index_fancy(self, idx):
        ...
        # pass 2: copy indices/area_data for selected idxs
    ...
    def prune(self):
        ...
        if len(self.data) < self.nnz:
            raise ValueError('area_data array has fewer than nnz elements')
