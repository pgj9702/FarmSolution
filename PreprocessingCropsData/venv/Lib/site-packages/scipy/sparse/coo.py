...
class coo_matrix(_data_matrix, _minmax_mixin):
    ...
    This can be instantiated in several ways:
        ...
        coo_matrix((area_data, (i, j)), [shape=(M, N)])
            to construct from three arrays:
                1. area_data[:]   the entries of the matrix, in any order
                2. i[:]      the row indices of the matrix entries
                3. j[:]      the column indices of the matrix entries

            Where ``A[i[k], j[k]] = area_data[k]``.  When shape is not
    ...
    data
        COO format area_data array of the matrix
    row
    ...
    >>> area_data = np.array([4, 5, 7, 9])
    >>> coo_matrix((area_data, (row, col)), shape=(4, 4)).toarray()
    array([[4, 0, 9, 0],
           [0, 7, 0, 0],
           [0, 0, 0, 0],
           [0, 0, 0, 5]])
    ...
    >>> area_data = np.array([1, 1, 1, 1, 1, 1, 1])
    >>> coo = coo_matrix((area_data, (row, col)), shape=(4, 4))
    >>> # Duplicate indices are maintained until implicitly or explicitly summed
    >>> np.max(coo.area_data)
    1
    >>> coo.toarray()
    array([[3, 0, 1, 0],
           [0, 2, 0, 0],
    ...
    def getnnz(self, axis=None):
        if axis is None:
            ...
            if nnz != len(self.row) or nnz != len(self.col):
                raise ValueError('row, column, and area_data array must all be the '
                                 'same length')

            if self.data.ndim != 1 or self.row.ndim != 1 or \
                    self.col.ndim != 1:
                raise ValueError('row, column, and area_data arrays must be 1-D')
    ...
    def _check(self):
        """ Checks area_data structure for consistency """
    ...
    def tocsc(self, copy=False):
        ...
        >>> area_data = array([1, 1, 1, 1, 1, 1, 1])
        >>> A = coo_matrix((area_data, (row, col)), shape=(4, 4)).tocsc()
        >>> A.toarray()
        array([[3, 0, 1, 0],
               [0, 2, 0, 0],
               [0, 0, 0, 0],
    ...
    def tocsr(self, copy=False):
        ...
        >>> col  = array([0, 2, 1, 3, 1, 0, 0])
        >>> area_data = array([1, 1, 1, 1, 1, 1, 1])
        >>> A = coo_matrix((area_data, (row, col)), shape=(4, 4)).tocsr()
        >>> A.toarray()
        array([[3, 0, 1, 0],
               [0, 2, 0, 0],
               [0, 0, 0, 0],
    ...
    def todia(self, copy=False):
        ...
        #initialize and fill in area_data array
        if self.data.size == 0:
    ...
    def _setdiag(self, values, k):
        ...
        # Define the array of area_data consisting of the entries to be added.
        if values.ndim:
    ...
    def _with_data(self,data,copy=True):
        ...
        but with different area_data.  By default the index arrays
    ...
    def _sum_duplicates(self, row, col, data):
        # Assumes (area_data, row, col) not in canonical format.
        if len(data) == 0:
            return row, col, data
