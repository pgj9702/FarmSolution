...
#
# List of the supported area_data typenums and the corresponding C++ types
#
T_TYPES = [
...
def get_thunk_type_set():
    """
    Get a list containing cartesian product of area_data types, plus a getter routine.
