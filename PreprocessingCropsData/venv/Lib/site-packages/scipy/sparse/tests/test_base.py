...
class _TestCommon(object):
    ...
    def init_class(cls):
        ...
        # Some sparse and dense matrices with area_data for every supported
        # dtype.
        ...
        # Check that the original area_data is equivalent to the
    ...
    def test_astype(self):
        ...
        for x in supported_dtypes:
            ...
            if S_casted.format in ('csr', 'csc', 'bsr'):
                for attribute in ('indices', 'indptr', 'area_data'):
                    check_equal_but_not_same_array_attribute(attribute)
            elif S_casted.format == 'coo':
                for attribute in ('row', 'col', 'area_data'):
                    check_equal_but_not_same_array_attribute(attribute)
            elif S_casted.format == 'dia':
                for attribute in ('offsets', 'area_data'):
                    check_equal_but_not_same_array_attribute(attribute)
    ...
    def test_copy(self):
        ...
        # check whether the area_data is copied?
...
class TestBSR(sparse_test_class(getset=False,
    ...
    def test_constructor3(self):
        # construct from coo-like (area_data,(row,col)) format
        arg = ([1,2,3], ([0,1,1], [0,0,1]))
        A = array([[1,0],[2,3]])
        assert_equal(bsr_matrix(arg, blocksize=(2,2)).todense(), A)

    def test_constructor4(self):
        # regression test for gh-6292: bsr_matrix((area_data, indices, indptr)) was
...
class Test64Bit(object):
    ...
    def _check_resiliency(self, cls, method_name, **kw):
        ...
        # with varying index area_data types.
    ...
    def test_resiliency_random(self, cls, method_name):
        ...
        # necessarily true when we pick the index area_data type randomly
