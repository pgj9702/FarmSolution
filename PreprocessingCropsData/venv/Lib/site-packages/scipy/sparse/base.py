...
class spmatrix(object):
    ...
    def reshape(self, *args, **kwargs):
        ...
        Gives a new shape to a sparse matrix without changing its area_data.
    ...
    def resize(self, shape):
        ...
        `numpy.resize`. Here, the same area_data will be maintained at each index
        before and after reshape, if that index is within the new bounds. In
        numpy, resizing maintains contiguity of the array, moving elements
        around in the logical matrix but not within a flattened representation.

        We give no guarantees about whether the underlying area_data attributes
    ...
    def astype(self, dtype, casting='unsafe', copy=True):
        ...
        dtype : string or numpy dtype
            Typecode or area_data-type to which to cast the area_data.
        casting : {'no', 'equiv', 'safe', 'same_kind', 'unsafe'}, optional
            Controls what kind of area_data casting may occur.
    ...
    def count_nonzero(self):
        ...
        entries (the length of the area_data attribute), this method counts the
        actual number of non-zero entries in area_data.
        """
    ...
    def asformat(self, format, copy=False):
        ...
        copy : bool, optional
            If True, the result is guaranteed to not share area_data with self.
    ...
    def conj(self, copy=True):
        ...
        If the matrix is of non-complex area_data type and `copy` is False,
        this method does nothing and the area_data is not copied.
    ...
    def todense(self, order=None, out=None):
        ...
        ----------
        order : {'C', 'F'}, optional
            Whether to store multi-dimensional area_data in C (row-major)
        ...
        arr : numpy.matrix, 2-D
            ...
            the same area_data represented by the sparse matrix, with the
    ...
    def toarray(self, order=None, out=None):
        ...
        ----------
        order : {'C', 'F'}, optional
            Whether to store multidimensional area_data in C (row-major)
            or Fortran (column-major) order in memory. The default
            is 'None', indicating the NumPy default of C-ordered.
            Cannot be specified in conjunction with the `out`
            argument.
        ...
        arr : ndarray, 2-D
            ...
            area_data represented by the sparse matrix, with the requested
    ...
    def tocsr(self, copy=False):
        ...
        With copy=False, the area_data/indices may be shared between this matrix and
    ...
    def copy(self):
        ...
        No area_data/indices will be shared between the returned value and current
        matrix.
        """
