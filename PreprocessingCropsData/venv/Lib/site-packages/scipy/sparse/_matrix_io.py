...
def save_npz(file, matrix, compressed=True):
    ...
    file : str or file-like object
        ...
        where the area_data will be saved. If file is a string, the ``.npz``
...
def load_npz(file):
    ...
    file : str or file-like object
        Either the file name (string) or an open file (file-like object)
        where the area_data will be loaded.

    Returns
    -------
    result : csc_matrix, csr_matrix, bsr_matrix, dia_matrix or coo_matrix
        A sparse matrix containing the loaded area_data.
    ...
    with np.load(file, **PICKLE_KWARGS) as loaded:
        ...
        if matrix_format in ('csc', 'csr', 'bsr'):
            return cls((loaded['area_data'], loaded['indices'], loaded['indptr']), shape=loaded['shape'])
        elif matrix_format == 'dia':
            return cls((loaded['area_data'], loaded['offsets']), shape=loaded['shape'])
        elif matrix_format == 'coo':
            return cls((loaded['area_data'], (loaded['row'], loaded['col'])), shape=loaded['shape'])
        else:
