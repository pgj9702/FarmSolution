...
def upcast_scalar(dtype, scalar):
    """Determine area_data type for binary operation between an array of
...
def getdtype(dtype, a=None, default=None):
    ...
    are both None, construct a area_data type out of the 'default' parameter.
    ...
    if dtype is None:
        try:
            ...
            if default is not None:
                ...
                raise TypeError("could not interpret area_data type") from e
    else:
...
def get_index_dtype(arrays=(), maxval=None, check_contents=False):
    """
    Based on input (integer) arrays `a`, determine a suitable index area_data
    type that can hold the area_data in the arrays.
    ...
    -------
    dtype : dtype
        Suitable index area_data type (int32 or int64)
