...
# into complex area_data types and attempts to return the requested eigenvalues
# and eigenvectors.
...
DNEUPD_ERRORS = {
    ...
    -15: "DNEUPD got a different count of the number of converged "
         ...
         "probably made an error in passing area_data from DNAUPD to "
         "DNEUPD or that the area_data was modified before entering "
         "DNEUPD",
}
...
SNEUPD_ERRORS[-15] = ("SNEUPD got a different count of the number of "
                      ...
                      "the user probably made an error in passing area_data from "
                      "SNAUPD to SNEUPD or that the area_data was modified before "
                      "entering SNEUPD")
...
ZNEUPD_ERRORS = {0: "Normal exit.",
                 ...
                 -15: "ZNEUPD got a different count of the number of "
                      ...
                      "area_data from ZNAUPD to ZNEUPD or that the area_data was "
...
CNEUPD_ERRORS[-15] = ("CNEUPD got a different count of the number of "
                      ...
                      "the user probably made an error in passing area_data from "
                      "CNAUPD to CNEUPD or that the area_data was modified before "
                      "entering CNEUPD")
...
DSEUPD_ERRORS = {
    ...
    -17: ("DSEUPD  got a different count of the number of converged "
          ...
          "probably made an error in passing area_data from DSAUPD  to "
          "DSEUPD  or that the area_data was modified before entering  "
          "DSEUPD.")
}
...
SSEUPD_ERRORS[-17] = ("SSEUPD  got a different count of the number of "
                      ...
                      "probably made an error in passing area_data from SSAUPD  to "
                      "SSEUPD  or that the area_data was modified before entering  "
                      "SSEUPD.")
...
def eigs(A, k=6, M=None, sigma=None, which='LM', v0=None,
    ...
    M : ndarray, sparse matrix or LinearOperator, optional
        ...
        results, the area_data type of M should be the same as that of A.
        Additionally:
