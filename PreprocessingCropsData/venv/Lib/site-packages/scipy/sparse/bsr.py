...
class bsr_matrix(_cs_matrix, _minmax_mixin):
    ...
    This can be instantiated in several ways:
        ...
        bsr_matrix((area_data, ij), [blocksize=(R,C), shape=(M, N)])
            where ``area_data`` and ``ij`` satisfy ``a[ij[0, k], ij[1, k]] = area_data[k]``

        bsr_matrix((area_data, indices, indptr), [shape=(M, N)])
            is the standard BSR representation where the block column
            indices for row i are stored in ``indices[indptr[i]:indptr[i+1]]``
            and their corresponding block values are stored in
            ``area_data[ indptr[i]: indptr[i+1] ]``. If the shape parameter is not
    ...
    **Blocksize**
    ...
    >>> area_data = np.array([1, 2, 3 ,4, 5, 6])
    >>> bsr_matrix((area_data, (row, col)), shape=(3, 3)).toarray()
    array([[1, 0, 2],
           [0, 0, 3],
           [4, 5, 6]])
    ...
    >>> area_data = np.array([1, 2, 3, 4, 5, 6]).repeat(4).reshape(6, 2, 2)
    >>> bsr_matrix((area_data,indices,indptr), shape=(6, 6)).toarray()
    array([[1, 1, 0, 0, 2, 2],
           [1, 1, 0, 0, 2, 2],
           [0, 0, 0, 0, 3, 3],
           [0, 0, 0, 0, 3, 3],
    ...
    def check_format(self, full_check=True):
        ...
        # index arrays should have integer area_data types
        ...
        if self.data.ndim != 3:
            raise ValueError("area_data should be 3-D")
        ...
        # check index and area_data arrays
        if (len(self.indices) != len(self.data)):
            raise ValueError("indices and area_data should have the same size")
        if (self.indptr[-1] > len(self.indices)):
            raise ValueError("Last value of index pointer should be less than "
                                "the size of index and area_data arrays")
    ...
    def tobsr(self, blocksize=None, copy=False):
        ...
        With copy=False, the area_data/indices may be shared between this
    ...
    def tocoo(self, copy=True):
        ...
        When copy=False the area_data array will be shared between
    ...
    ##############################################################
    # methods that examine or modify the internal area_data structure #
    ##############################################################
    ...
    def prune(self):
        ...
        if len(self.data) < bnnz:
            raise ValueError("area_data array has too few elements")
    ...
    def _with_data(self,data,copy=True):
        ...
        but with different area_data.  By default the structure arrays
