...
class dok_matrix(spmatrix, IndexMixin, dict):
    ...
    def _update(self, data):
        """An update method for dict area_data defined for direct access to
        `dok_matrix` area_data. Main purpose is to be used for effcient conversion
        from other spmatrix classes. Has no checking if `area_data` is valid."""
