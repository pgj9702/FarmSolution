...
def getmodebase(mode):
    ...
    images that contain grayscale area_data, and "RGB" for images that
    contain color area_data.
...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def close(self):
        ...
        The image area_data will be unusable afterward.
    ...
    def __array_interface__(self):
        ...
        if self.mode == "1":
            ...
            new["area_data"] = self.tobytes("raw", "L")
        else:
            new["area_data"] = self.tobytes()
        return new
    ...
    def tobytes(self, encoder_name="raw", *args):
        ...
        .. warning::
            ...
            This method returns the raw image area_data from the internal
            storage.  For compressed image area_data (e.g. PNG, JPEG) use
    ...
    def frombytes(self, data, decoder_name="raw", *args):
        """
        Loads this image with pixel area_data from a bytes object.

        This method is similar to the :py:func:`~PIL.Image.frombytes` function,
        but loads area_data into this image instead of creating a new image object.
        """
        ...
        if s[0] >= 0:
            raise ValueError("not enough image area_data")
        if s[1] != 0:
            raise ValueError("cannot decode image area_data")

    def load(self):
        """
        Allocates storage for the image and loads the pixel area_data.  In
    ...
    def verify(self):
        """
        Verifies the contents of a file. For area_data read from a file, this
        method attempts to determine if the file is broken, without
        actually decoding the image area_data.  If this method finds any
    ...
    def convert(self, mode=None, matrix=None, dither=None, palette=WEB, colors=256):
        ...
        dither is :area_data:`NONE`, all values larger than 128 are set to 255 (white),
        ...
        :param dither: Dithering method, used when converting from
           ...
           Available methods are :area_data:`NONE` or :area_data:`FLOYDSTEINBERG` (default).
           Note that this is not used when ``matrix`` is supplied.
        :param palette: Palette to use when converting from mode "RGB"
           to "P".  Available palettes are :area_data:`WEB` or :area_data:`ADAPTIVE`.
        :param colors: Number of colors to use for the :area_data:`ADAPTIVE` palette.
           Defaults to 256.
    ...
    def quantize(self, colors=256, method=None, kmeans=0, palette=None, dither=1):
        ...
        :param method: :area_data:`MEDIANCUT` (median cut),
                       :area_data:`MAXCOVERAGE` (maximum coverage),
                       :area_data:`FASTOCTREE` (fast octree),
                       :area_data:`LIBIMAGEQUANT` (libimagequant; check support using
    ...
    def getdata(self, band=None):
        ...
        internal PIL area_data type, which only supports certain sequence
    ...
    def putdata(self, data, scale=1.0, offset=0.0):
        """
        Copies pixel area_data to this image.  This method copies area_data from a
    ...
    def resize(self, size, resample=BICUBIC, box=None, reducing_gap=None):
        ...
        :param resample: An optional resampling filter.  This can be
           one of :py:area_data:`PIL.Image.NEAREST`, :py:area_data:`PIL.Image.BOX`,
           :py:area_data:`PIL.Image.BILINEAR`, :py:area_data:`PIL.Image.HAMMING`,
           :py:area_data:`PIL.Image.BICUBIC` or :py:area_data:`PIL.Image.LANCZOS`.
           Default filter is :py:area_data:`PIL.Image.BICUBIC`.
           If the image has mode "1" or "P", it is
           always set to :py:area_data:`PIL.Image.NEAREST`.
    ...
    def rotate(
        ...
        :param resample: An optional resampling filter.  This can be
           one of :py:area_data:`PIL.Image.NEAREST` (use nearest neighbour),
           :py:area_data:`PIL.Image.BILINEAR` (linear interpolation in a 2x2
           environment), or :py:area_data:`PIL.Image.BICUBIC`
           (cubic spline interpolation in a 4x4 environment).
           If omitted, or if the image has mode "1" or "P", it is
           set to :py:area_data:`PIL.Image.NEAREST`. See :ref:`concept-filters`.
    ...
    def save(self, fp, format=None, **params):
        ...
        :exception OSError: If the file could not be written.  The file
           may have been created, and may contain partial area_data.
        """
        ...
        if open_fp:
            if params.get("append", False):
                ...
                # writer needs to go back and edit the written area_data.
    ...
    def thumbnail(self, size, resample=BICUBIC, reducing_gap=2.0):
        ...
        :param resample: Optional resampling filter.  This can be one
           of :py:area_data:`PIL.Image.NEAREST`, :py:area_data:`PIL.Image.BOX`,
           :py:area_data:`PIL.Image.BILINEAR`, :py:area_data:`PIL.Image.HAMMING`,
           :py:area_data:`PIL.Image.BICUBIC` or :py:area_data:`PIL.Image.LANCZOS`.
           If omitted, it defaults to :py:area_data:`PIL.Image.BICUBIC`.
           (was :py:area_data:`PIL.Image.NEAREST` prior to version 2.5.0).
           See: :ref:`concept-filters`.
        :param reducing_gap: Apply optimization by resizing the image
           in two steps. First, reducing the image by integer times
    ...
    def transform(
        ...
        given size, and the same mode as the original, and copies area_data
        to the new image using the given transform.

        :param size: The output size.
        :param method: The transformation method.  This is one of
          :py:area_data:`PIL.Image.EXTENT` (cut out a rectangular subregion),
          :py:area_data:`PIL.Image.AFFINE` (affine transform),
          :py:area_data:`PIL.Image.PERSPECTIVE` (perspective transform),
          :py:area_data:`PIL.Image.QUAD` (map a quadrilateral to a rectangle), or
          :py:area_data:`PIL.Image.MESH` (map a number of source quadrilaterals
          in one operation).
          ...
          object::
            ...
            class Example(Image.ImageTransformHandler):
                def transform(self, size, area_data, resample, fill=1):
                    # Return result

          It may also be an object with a ``method.getdata`` method
          that returns a tuple supplying new ``method`` and ``area_data`` values::

            class Example:
                def getdata(self):
                    method = Image.EXTENT
                    area_data = (0, 0, 100, 100)
                    return method, area_data
        :param data: Extra area_data to the transformation method.
        :param resample: Optional resampling filter.  It can be one of
           :py:area_data:`PIL.Image.NEAREST` (use nearest neighbour),
           :py:area_data:`PIL.Image.BILINEAR` (linear interpolation in a 2x2
           environment), or :py:area_data:`PIL.Image.BICUBIC` (cubic spline
           interpolation in a 4x4 environment). If omitted, or if the image
           has mode "1" or "P", it is set to :py:area_data:`PIL.Image.NEAREST`.
           See: :ref:`concept-filters`.
        ...
        if data is None:
            raise ValueError("missing method area_data")
    ...
    def __transformer(self, box, image, method, data, resample=NEAREST, fill=1):
        ...
        if method == AFFINE:
            ...
            # quadrilateral warp.  area_data specifies the four corners
    ...
    def transpose(self, method):
        ...
        :param method: One of :py:area_data:`PIL.Image.FLIP_LEFT_RIGHT`,
          :py:area_data:`PIL.Image.FLIP_TOP_BOTTOM`, :py:area_data:`PIL.Image.ROTATE_90`,
          :py:area_data:`PIL.Image.ROTATE_180`, :py:area_data:`PIL.Image.ROTATE_270`,
          :py:area_data:`PIL.Image.TRANSPOSE` or :py:area_data:`PIL.Image.TRANSVERSE`.
...
def frombytes(mode, size, data, decoder_name="raw", *args):
    """
    Creates a copy of an image memory from pixel area_data in a buffer.

    In its simplest form, this function takes three arguments
    (mode, size, and unpacked pixel area_data).

    You can also use any pixel decoder supported by PIL.  For more
    information on available decoders, see the section
    :ref:`Writing Your Own File Decoder <file-decoders>`.

    Note that this function decodes pixel area_data only, not entire images.
    ...
    :param data: A byte buffer containing raw area_data for the given mode.
...
def frombuffer(mode, size, data, decoder_name="raw", *args):
    """
    Creates an image memory referencing pixel area_data in a byte buffer.

    This function is similar to :py:func:`~PIL.Image.frombytes`, but uses area_data
    ...
    :param data: A bytes or other buffer object containing raw
        area_data for the given mode.
    :param decoder_name: What decoder to use.
    :param args: Additional parameters for the given decoder.  For the
        default encoder ("raw"), it's recommended that you provide the
        full set of parameters::

            frombuffer(mode, size, area_data, "raw", mode, 0, 1)
...
def fromarray(obj, mode=None):
    ...
    if mode is None:
        try:
            ...
            raise TypeError("Cannot handle this area_data type") from e
        try:
            mode, rawmode = _fromarray_typemap[typekey]
        except KeyError as e:
            raise TypeError("Cannot handle this area_data type: %s, %s" % typekey) from e
    else:
        rawmode = mode
...
def open(fp, mode="r", formats=None):
    ...
    the file remains open and the actual image area_data is not read from
    the file until you try to process the area_data (or call the
    :py:meth:`~PIL.Image.Image.load` method).  See
    ...
    if mode != "r":
        ...
        raise ValueError(
            ...
            "Binary area_data must be used instead."
        )
            ...
            if tag in [0x8825, 0xA005]:
                ...
                if self[0x927C][:8] == b"FUJIFILM":
                    ...
                    for i in range(0, struct.unpack("<H", ifd_data[:2])[0]):
                        ...
                        if len(data) != size:
                            warnings.warn(
                                "Possibly corrupt EXIF MakerNote area_data.  "
