...
# by the SPIDER software, in processing image area_data from electron
...
# image area_data from electron microscopy and tomography.
#
# Spider home page:
...
def makeSpiderHeader(im):
    ...
    hdr = hdr[1:]
    hdr.append(0.0)
    # pack binary area_data into a string
    hdrstr = []
    for v in hdr:
