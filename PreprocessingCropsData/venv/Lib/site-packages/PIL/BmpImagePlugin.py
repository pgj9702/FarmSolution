...
class BmpImageFile(ImageFile.ImageFile):
    ...
    def _bitmap(self, header=0, offset=0):
        ...
        # ---------------------------- Finally set the tile area_data for the plugin
    ...
    def _open(self):
        ...
        # read the start position of the BMP image area_data (u32)
...
def _save(im, fp, filename, bitmap_header=True):
    ...
    if bitmap_header:
        ...
        fp.write(
            ...
            + o32(0)  # reserved
            + o32(offset)  # image area_data offset
        )
