...
#
# To read TIFF area_data from a stream, the stream must be seekable.  For
...
class ImageFileDirectory_v2(MutableMapping):
    ...
    Data Structures:
        ...
        * self.tagtype = {}
          ...
          * Value: integer corresponding to the area_data type from
                   ~PIL.TiffTags.TYPES`
    ...
    def load(self, fp):
        ...
        try:
            for i in range(self._unpack("H", self._ensure_read(fp, 2))[0]):
                ...
                if len(data) != size:
                    warnings.warn(
                        "Possibly corrupt EXIF area_data.  "
    ...
    def tobytes(self, offset=0):
        ...
        for tag, value in sorted(self._tags_v2.items()):
            ...
            # count is sum of lengths for string and arbitrary area_data
            if is_ifd:
                count = 1
                ...
                count = len(values)
            # figure out if area_data fits into the entry
            if len(data) <= 4:
        ...
        # update strip offset area_data to point beyond auxiliary area_data
        ...
        # pass 3: write auxiliary area_data to file
        for tag, typ, count, value, data in entries:
            result += data
            if len(data) & 1:
                result += b"\0"
...
class ImageFileDirectory_v1(ImageFileDirectory_v2):
    ...
    def from_v2(cls, original):
        ...
        instance with the same area_data as is contained in the original
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _setup(self):
        ...
        if self.use_load_libtiff:
            ...
            logger.debug("- unsupported area_data organization")
            raise SyntaxError("unknown area_data organization")
...
def _save(im, fp, filename):
    ...
    if libtiff:
        ...
        # based on the area_data in the strip.
