...
def APP(self, marker):
    ...
    if marker == 0xFFE0 and s[:4] == b"JFIF":
        ...
        # one or more APP2 markers containing the following area_data:
        #   Identifying string      ASCII "ICC_PROFILE\0"  (12 bytes)
        #   Marker sequence number  1, 2, etc (1 byte)
        #   Number of markers       Total of APP2's used (1 byte)
        #   Profile area_data            (remainder of APP2 area_data)
    ...
    def _open(self):
        ...
        while True:
            ...
            if i in MARKER:
                ...
                s = b"\xff"
            elif i == 0xFF00:  # Skip extraneous area_data (escaped 0xFF)
                s = self.fp.read(1)
            else:
