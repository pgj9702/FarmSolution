...
# 2001-04-16 fl   Don't close area_data source in "open" method (0.6)
...
class PngInfo:
    ...
    def add(self, cid, data, after_idat=False):
        ...
        :param data: a byte string of the encoded area_data
...
class PngImageFile(ImageFile.ImageFile):
            ...
            while True:
                ...
                if cid == b"fcTL":
                    if frame_start:
                        ...
                        raise SyntaxError("APNG missing frame area_data")
                    frame_start = True
    ...
    def load_read(self, read_bytes):
        """internal: read more image area_data"""
        ...
        # read more area_data from this chunk
        if read_bytes <= 0:
    ...
    def load_end(self):
        """internal: finished reading image area_data"""
        while True:
            self.fp.read(4)  # CRC
