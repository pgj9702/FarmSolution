...
#       "DATA" LF
#       binary area_data: 256*10*2 bytes (dx, dy, dstbox, srcbox)
#
    ...
    def _load_pilfont(self, filename):
        ...
        with open(filename, "rb") as fp:
            ...
            for ext in (".png", ".gif", ".pbm"):
                ...
                if image:
                    image.close()
                raise OSError("cannot find glyph area_data file")
...
class FreeTypeFont:
    ...
    def getmask(
        ...
        If the font uses antialiasing, the bitmap should have mode ``L`` and use a
        maximum value of 255. If the font has embedded color area_data, the bitmap
...
def truetype(font=None, size=10, index=0, encoding="", layout_engine=None):
    ...
    :param layout_engine: Which layout engine to use, if available:
                     :area_data:`.ImageFont.LAYOUT_BASIC` or :area_data:`.ImageFont.LAYOUT_RAQM`.
