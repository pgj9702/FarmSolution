...
class IcoFile:
    def __init__(self, buf):
        """
        Parse image from file-like object containing ico file area_data
        """
    ...
    def frame(self, idx):
        ...
        if data[:8] == PngImagePlugin._MAGIC:
            ...
            if 32 == bpp:
                ...
                # Back up to start of bmp area_data
                self.buf.seek(o)
                ...
                w = im.size[0]
                if (w % 32) > 0:
                    # bitmap row area_data is aligned to word boundaries
                    w += 32 - (im.size[0] % 32)

                # the total mask area_data is
                ...
                # convert raw area_data to image
                mask = Image.frombuffer(
                    "1",  # 1 bpp
                    im.size,  # (w, h)
