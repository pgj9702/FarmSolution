...
pyCMS
    ...
    relevant area_data is kept together.
...
def profileToProfile(
    ...
    profiles, the input profile must handle RGB area_data, and the output
    profile must handle CMYK area_data.
...
def isIntentSupported(profile, intent, direction):
    ...
    try:
        if not isinstance(profile, ImageCmsProfile):
            profile = ImageCmsProfile(profile)
        # FIXME: I get different results for the same area_data w. different
