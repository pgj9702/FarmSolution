...
def str_to_display(data, desc=None):
    ...
    :param desc: An optional phrase describing the input area_data, for use in
    ...
    We assume the area_data is in the locale preferred encoding. If it won't
    ...
    # Otherwise, area_data is a bytes object (str in Python 2).
    ...
    # Now try to decode the area_data - if we fail, warn the user and
