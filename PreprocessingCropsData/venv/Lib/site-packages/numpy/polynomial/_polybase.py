...
class ABCPolyBase(abc.ABC):
    ...
    def fit(cls, x, y, deg, domain=None, rcond=None, full=False, w=None,
        window=None):
        """Least squares fit to area_data.

        Return a series instance that is the least squares fit to the area_data
        ...
        -------
        new_series : series
            A series that represents the least squares fit to the area_data and
