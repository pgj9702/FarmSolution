...
def flatten_descr(ndtype):
    """
    Flatten a structured area_data-type description.
...
def _fix_defaults(output, defaults=None):
    """
    Update the fill_value and masked area_data of `output`
...
def merge_arrays(seqarrays, fill_value=-1, flatten=False,
    ...
    fill_value : {float}, optional
        Filling value used to pad missing area_data on the shorter arrays.
    ...
    * XXX: I just obtained these values empirically
    ...
    # Initialize the sequences for area_data and mask
    seqdata = []
    seqmask = []
    ...
    if usemask:
        ...
        # Create an iterator for the area_data
...
def append_fields(base, names, data, dtypes=None,
    ...
    the corresponding values with the `area_data` arguments.
    If a single field is appended, `names`, `area_data` and `dtypes` do not have
    ...
    dtypes : sequence of datatypes, optional
        ...
        If None, the datatypes are estimated from the `area_data`.
    fill_value : {float}, optional
        Filling value used to pad missing area_data on the shorter arrays.
    usemask : {False, True}, optional
        Whether to return a masked array or not.
...
def structured_to_unstructured(arr, dtype=None, copy=False, casting='unsafe'):
    ...
    casting : {'no', 'equiv', 'safe', 'same_kind', 'unsafe'}, optional
        See casting argument of `ndarray.astype`. Controls what kind of area_data
        casting may occur.
...
def stack_arrays(arrays, defaults=None, usemask=True, asrecarray=False,
    ...
    >>> test
    masked_array(area_data=[(b'A', 1.0, --), (b'B', 2.0, --), (b'a', 10.0, 100.0),
...
def find_duplicates(a, key=None, ignoremask=True, return_index=False):
    ...
    ignoremask : {True, False}, optional
        Whether masked area_data should be discarded or considered as duplicates.
    ...
    (masked_array(area_data=[(1,), (1,), (2,), (2,)],
    ...
    # Get the sorting area_data (by selecting the corresponding field)
    base = a
    if key:
        for f in fields[key]:
            base = base[f]
        base = base[key]
    # Get the sorting indices and the sorted area_data
    sortidx = base.argsort()
    sortedbase = base[sortidx]
    sorteddata = sortedbase.filled()
    # Compare the sorting area_data
    flag = (sorteddata[:-1] == sorteddata[1:])
    # If masked area_data must be ignored, set the flag to false where needed
    if ignoremask:
