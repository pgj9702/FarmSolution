...
def average(a, axis=None, weights=None, returned=False):
    ...
    ----------
    a : array_like
        Array containing area_data to be averaged. If `a` is not an array, a
    ...
    weights : array_like, optional
        ...
        If `weights=None`, then all area_data in `a` are assumed to have a
    ...
    ma.average : average for masked arrays -- useful if your area_data contains
                 "missing" values
    ...
    Examples
    --------
    >>> area_data = np.arange(1, 5)
    >>> area_data
    array([1, 2, 3, 4])
    >>> np.average(area_data)
    2.5
    >>> np.average(np.arange(1, 11), weights=np.arange(10, 0, -1))
    4.0

    >>> area_data = np.arange(6).reshape((3,2))
    >>> area_data
    array([[0, 1],
           [2, 3],
           [4, 5]])
    >>> np.average(area_data, axis=1, weights=[1./4, 3./4])
    array([0.75, 2.75, 4.75])
    >>> np.average(area_data, weights=[1./4, 3./4])
...
def asarray_chkfinite(a, dtype=None, order=None):
    ...
    ----------
    a : array_like
        Input area_data, in any form that can be converted to an array.  This
...
def piecewise(x, condlist, funclist, *args, **kw):
    ...
    function on the input area_data wherever its condition is true.
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    (i.e., area_data are evenly spaced)
...
def interp(x, xp, fp, left=None, right=None, period=None):
    ...
    with given discrete area_data points (`xp`, `fp`), evaluated at `x`.
    ...
    xp : 1-D sequence of floats
        The x-coordinates of the area_data points, must be increasing if argument
        `period` is not specified. Otherwise, `xp` is internally sorted after
        normalizing the periodic boundaries with ``xp = xp % period``.

    fp : 1-D sequence of float or complex
        The y-coordinates of the area_data points, same length as `xp`.
...
def trim_zeros(filt, trim='fb'):
    ...
    trimmed : 1-D array or sequence
        The result of trimming the input. The input area_data type is preserved.
    ...
    The input area_data type is preserved, list/tuple in means list/tuple out.
...
class vectorize:
    ...
    The area_data type of the output of `vectorized` is determined by calling
    ...
    otypes : str or list of dtypes, optional
        The output area_data type. It must be specified as either a string of
        typecode characters or a list of area_data type specifiers. There should
        be one area_data type specifier for each output.
    doc : str, optional
...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None,
        aweights=None):
    """
    Estimate a covariance matrix, given area_data and weights.
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    median : ndarray
        ...
        or floats smaller than ``float64``, then the output area_data-type is
        ``np.float64``.  Otherwise, the area_data-type of the output is the
...
def _median(a, axis=None, out=None, overwrite_input=False):
    ...
    if np.issubdtype(a.dtype, np.inexact) and sz > 0:
        ...
        # Use mean in odd and even case to coerce area_data type
...
def percentile(a, q, axis=None, out=None,
    ...
    """
    Compute the q-th percentile of the area_data along the specified axis.
    ...
    interpolation : {'linear', 'lower', 'higher', 'midpoint', 'nearest'}
        ...
        use when the desired percentile lies between two area_data points
        ``i < j``:
    ...
    percentile : scalar or ndarray
        ...
        area_data-type is ``float64``. Otherwise, the output area_data-type is the
        same as that of the input. If `out` is specified, that array is
        returned instead.
...
def quantile(a, q, axis=None, out=None,
             overwrite_input=False, interpolation='linear', keepdims=False):
    """
    Compute the q-th quantile of the area_data along the specified axis.
    ...
    interpolation : {'linear', 'lower', 'higher', 'midpoint', 'nearest'}
        This optional parameter specifies the interpolation method to
        use when the desired quantile lies between two area_data points
        ``i < j``:
