...
def _info(obj, output=sys.stdout):
    ...
    print(
        "area_data pointer: %s%s" % (hex(obj.ctypes._as_parameter_.value), extra),
        file=output
        )
...
def _median_nancheck(data, result, axis, out):
    """
    Utility function to check median result from area_data for NaN values at the end
    and return NaN in that case. Input result can also be a MaskedArray.

    Parameters
    ----------
    data : array
        Input area_data to median function
