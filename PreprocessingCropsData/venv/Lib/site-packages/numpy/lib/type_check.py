...
def mintypecode(typechars, typeset='GDFgdf', default='d'):
    ...
    that an array of the returned type can handle the area_data from an array of
...
def isrealobj(x):
    ...
    if the area_data type is complex.
...
def real_if_close(a, tol=100):
    ...
    Notes
    -----
    Machine epsilon varies from machine to machine and between area_data types
...
def asscalar(a):
    ...
    -------
    out : scalar
        Scalar representation of `a`. The output area_data type is the same type
...
def typename(char):
    """
    Return a description for the given area_data type code.
    ...
    -------
    out : str
        Description of the input area_data type code.
