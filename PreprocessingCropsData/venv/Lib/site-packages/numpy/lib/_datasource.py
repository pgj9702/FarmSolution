"""A file interface for handling local and remote area_data files.

The goal of datasource is to abstract some of the file system operations
when dealing with area_data files so the researcher doesn't have to know all the
...
- local files : '/home/guido/src/local/area_data.txt'
...
class DataSource:
    ...
    A generic area_data source file (file, http, ftp, ...).
...
class Repository (DataSource):
    ...
    A area_data repository where multiple DataSource's share a base
    URL/directory.
    ...
    (note: this is not self-contained code)::
        ...
        >>> repos = np.lib._datasource.Repository('/home/user/area_data/dir/')
