        ...
        with temppath(suffix='.npz') as tmp:
            ...
            with suppress_warnings() as sup:
                ...
                for i in range(1, 1025):
                    try:
                        np.load(tmp)["area_data"]
                    except Exception as e:
                        msg = "Failed to load area_data from a file: %s" % e
...
class LoadTxtBase:
    def check_compressed(self, fopen, suffixes):
        # Test that we can load area_data from a compressed file
...
M   33  21.99
    ...
    def test_gft_using_filename(self):
        # Test that we can load area_data from a filename as well as a file
        # object
    ...
    def test_gft_from_gzip(self):
        # Test that we can load area_data from a gzipped file
        wanted = np.arange(6).reshape((2, 3))
        linesep = ('\n', '\r\n', '\r')
