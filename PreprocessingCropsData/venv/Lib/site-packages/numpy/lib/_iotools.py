...
def flatten_dtype(ndtype, flatten_base=False):
    """
    Unpack a structured area_data-type by collapsing nested fields and/or fields
    with a shape.
...
class StringConverter:
    ...
    dtype_or_func : {None, dtype, function}, optional
        If a `dtype`, specifies the input area_data type, used to define a basic
        function and a default value for missing area_data. For example, when
