...
def qr(a, mode='reduced'):
    ...
    the following area_data: {(0,1), (1,0), (1,2), (2,1)}. (Graph the points
    ...
    # calculate optimal size of work area_data 'work'
    lwork = 1
    work = zeros((lwork,), t)
...
def matrix_rank(M, tol=None, hermitian=False):
    ...
    example, if your area_data come from uncertain measurements with uncertainties
...
def lstsq(a, b, rcond="warn"):
    ...
    Examples
    --------
    Fit a line, ``y = mx + c``, through some noisy area_data-points:
    ...
    Plot the area_data along with the fitted line:

    >>> import matplotlib.pyplot as plt
    >>> _ = plt.plot(x, y, 'o', label='Original area_data', markersize=10)
