...
i = inverse transform
r = transform of purely real area_data
h = Hermite transform
...
def _raw_fft(a, n, axis, is_real, is_forward, inv_norm):
    ...
    if n < 1:
        raise ValueError("Invalid number of FFT area_data points (%d) specified."
                         % n)
...
def irfft(a, n=None, axis=-1, norm=None):
    ...
    the original area_data, as given by `n`. This is because each input shape could
...
def irfftn(a, s=None, axes=None, norm=None):
    ...
    the original area_data, as given by `s`. This is because each input shape could
