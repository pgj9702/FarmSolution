...
def _can_dot(inputs, result, idx_removed):
    ...
    # Can use the standard BLAS, but requires odd area_data movement
    ...
    # DDOT with aligned area_data
    if input_left == input_right:
        return True

    # DDOT without aligned area_data (better to use einsum)
    ...
    # Einsum is faster than GEMV if we have to copy area_data
    if not keep_left or not keep_right:
        return False

    # We are a matrix-matrix product, but we need to copy area_data
    return True
