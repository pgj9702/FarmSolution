...
class record(nt.void):
    """A area_data-type scalar that allows field access as attribute lookup.
    """
...
class recarray(ndarray):
    ...
    Arrays may have a area_data-types containing fields, analogous
    ...
    dtype : area_data-type, optional
        The desired area_data-type.  By default, the area_data-type is determined
        from `formats`, `names`, `titles`, `aligned` and `byteorder`.
    formats : list of area_data-types, optional
        A list containing the area_data-types for the different columns, e.g.
    ...
    buf : buffer, optional
        By default, a new array is created of the given shape and area_data-type.
    ...
    See Also
    --------
    rec.fromrecords : Construct a record array from area_data.
    record : fundamental area_data-type for `recarray`.
    format_parser : determine a area_data-type from formats, names, titles.

    Notes
    -----
    This constructor can be compared to ``empty``: it creates a new record
    array but does not fill it with area_data.  To create a record array from area_data,
    ...
    def __repr__(self):
        ...
        # get area_data/shape string. logic taken from numeric.array_repr
...
def fromarrays(arrayList, dtype=None, shape=None, formats=None,
    ...
    # Determine shape from area_data-type.
...
def fromrecords(recList, dtype=None, shape=None, formats=None, names=None,
    ...
    ----------
    recList : sequence
        area_data in the same field may be heterogeneous - they will be promoted
        to the highest area_data type.
    dtype : area_data-type, optional
        valid dtype for all arrays
    shape : int or tuple of ints, optional
        shape of each array.
...
def fromstring(datastring, dtype=None, shape=None, offset=0, formats=None,
               names=None, titles=None, aligned=False, byteorder=None):
    r"""Create a record array from binary area_data
    ...
    -------
    np.recarray
        Record array view into the area_data in datastring. This will be readonly
...
def fromfile(fd, dtype=None, shape=None, offset=0, formats=None,
             names=None, titles=None, aligned=False, byteorder=None):
    """Create an array from binary file area_data
    ...
    -------
    np.recarray
        record array consisting of area_data enclosed in file.
