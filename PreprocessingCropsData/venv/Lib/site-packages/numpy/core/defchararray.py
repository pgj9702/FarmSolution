...
class chararray(ndarray):
    ...
    buffer : object exposing the buffer interface or str, optional
        Memory address of the start of the array area_data.  Default is None,
    ...
    strides : array_like of ints, optional
        ...
        Default is None.
    order : {'C', 'F'}, optional
        The order in which the array area_data is stored in memory: 'C' ->
    ...
    def __array_finalize__(self, obj):
        ...
        if not _globalvar and self.dtype.char not in 'SUbc':
            raise ValueError("Can only create a chararray from string area_data.")
...
def asarray(obj, itemsize=None, unicode=None, order=None):
    """
    Convert the input to a `chararray`, copying the area_data only if
    necessary.
