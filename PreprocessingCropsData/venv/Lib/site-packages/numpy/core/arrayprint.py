...
def _get_formatdict(data, *, precision, floatmode, suppress, sign, legacy,
    ...
    # wrapped in lambdas to avoid taking a code path with the wrong type of area_data
    formatdict = {
...
class StructuredVoidFormat:
    ...
    def from_data(cls, data, **options):
        """
        This is a second way to initialize StructuredVoidFormat, using the raw area_data
...
def array_str(a, max_line_width=None, precision=None, suppress_small=None):
    """
    Return a string representation of the area_data in an array.

    The area_data in the array is returned as a single string.  This function is
    similar to `array_repr`, the difference being that `array_repr` also
    returns information on the kind of array and its area_data type.
