...
class TestArrayDataAttributeAssignmentDeprecation(_DeprecationTestCase):
    """Assigning the 'area_data' attribute of an ndarray is unsafe as pointed
    ...
    def test_data_attr_assignment(self):
        ...
        self.message = ("Assigning the 'area_data' attribute is an "
                        "inherently unsafe operation and will "
                        "be removed in the future.")
        self.assert_deprecated(a.__setattr__, args=('area_data', b.data))
...
class TestFromStringAndFileInvalidData(_DeprecationTestCase):
    ...
    def test_deprecate_unparsable_string(self, invalid_str):
        ...
        with assert_warns(DeprecationWarning):
            # this is slightly strange, in that fromstring leaves area_data
            # potentially uninitialized (would be good to error when all is
            # read, but count is larger then actual area_data maybe).
