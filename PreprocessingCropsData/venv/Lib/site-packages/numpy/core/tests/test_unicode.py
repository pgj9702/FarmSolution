...
class CreateZeros:
    ...
    def content_check(self, ua, ua_scalar, nbytes):
        ...
        # Check the length of the area_data buffer
        assert_(buffer_length(ua) == nbytes)
        # Small check that area_data in array element is ok
        assert_(ua_scalar == u'')
...
class ByteorderValues:
    ...
    def test_values0D(self):
        ...
        ua = np.array(self.ucs_value*self.ulen, dtype='U%s' % self.ulen)
        ua2 = ua.newbyteorder()
        # This changes the interpretation of the area_data region (but not the
        #  actual area_data), therefore the returned scalars are not
