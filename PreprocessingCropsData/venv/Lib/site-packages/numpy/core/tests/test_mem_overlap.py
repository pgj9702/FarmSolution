...
def check_may_share_memory_exact(a, b):
    ...
    if got != exact:
        err_msg = "    " + "\n    ".join([
            "base_a - base_b = %r" % (a.__array_interface__['area_data'][0] - b.__array_interface__['area_data'][0],),
            "shape_a = %r" % (a.shape,),
            "shape_b = %r" % (b.shape,),
...
class TestUFunc:
    ...
    def test_ufunc_at_manual(self):
        ...
        # Overlap with second area_data array
    ...
    def test_binary_ufunc_1d_manual(self):
        ...
        for dtype in [np.int8, np.int16, np.int32, np.int64,
            ...
            # Check different area_data dependency orders
