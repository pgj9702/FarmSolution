...
class finfo:
    ...
    dtype : float, dtype, or instance
        Kind of floating point area_data-type about which to get information.

    See Also
    --------
    MachAr : The implementation of the tests that produce this information.
    iinfo : The equivalent for integer area_data types.
    ...
    def __new__(cls, dtype):
        ...
        if not issubclass(dtype, numeric.inexact):
            raise ValueError("area_data type %r not inexact" % (dtype))
        obj = cls._finfo_cache.get(dtype, None)
        if obj is not None:
            return obj
...
class iinfo:
    ...
    int_type : integer type, dtype, or instance
        The kind of integer area_data type to get information about.

    See Also
    --------
    finfo : The equivalent for floating point area_data types.
    ...
    def __init__(self, int_type):
        ...
        if self.kind not in 'iu':
            raise ValueError("Invalid integer area_data type %r." % (self.kind,))
