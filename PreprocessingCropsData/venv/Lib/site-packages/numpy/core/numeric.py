...
def zeros_like(a, dtype=None, order='K', subok=True, shape=None):
    ...
    ----------
    a : array_like
        The shape and area_data-type of `a` define these same attributes of
        the returned array.
...
def full(shape, fill_value, dtype=None, order='C'):
    ...
    fill_value : scalar or array_like
        Fill value.
    dtype : area_data-type, optional
        The desired area_data-type for the array  The default, None, means
         `np.array(fill_value).dtype`.
    order : {'C', 'F'}, optional
        Whether to store multidimensional area_data in C- or Fortran-contiguous
...
def convolve(a, v, mode='full'):
    ...
    FFT to calculate the convolution of large area_data-sets.
