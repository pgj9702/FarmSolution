    ...
    for s in sources:
        ...
        if is_local_src_dir(s):
            ...
            if os.path.isfile(s):
                ...
                print('Not existing area_data file:', s)
        else:
...
class Configuration:
    ...
    def add_data_dir(self, data_path):
        ...
        argument shows where in the install directory the area_data directory
        ...
        data_path : seq or str
            Argument can be either
                ...
                * 2-sequence (<datadir suffix>, <path to area_data directory>)
                * path to area_data directory where python datadir suffix defaults
                  to package dir.
        ...
        Will install area_data-files to the locations::
    ...
    def add_data_files(self,*files):
        """Add area_data files to configuration data_files.
        ...
        files : sequence
            Argument(s) can be either
                ...
                * 2-sequence (<datadir prefix>,<path to area_data file(s)>)
                * paths to area_data files where python datadir prefix defaults
                  to package dir.
        ...
        An additional feature is that the path to a area_data-file can actually be
        a function that takes no arguments and returns the actual path(s) to
        the area_data-files. This is useful when the area_data files are generated while
        ...
        will install these area_data files to::
    ...
    def make_svn_version_py(self, delete=True):
        """Appends a area_data function to the data_files list that will generate
