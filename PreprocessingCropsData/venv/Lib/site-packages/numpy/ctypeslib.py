...
class _ndptr(_ndptr_base):
    ...
    def from_param(cls, obj):
        ...
        if cls._dtype_ is not None \
            ...
            raise TypeError("array must have area_data type %s" % cls._dtype_)
...
class _concrete_ndptr(_ndptr):
    ...
    def contents(self):
        """
        Get an ndarray viewing the area_data pointed to by this pointer.
...
def ndpointer(dtype=None, ndim=None, shape=None, flags=None):
    ...
    These include area_data type, number of dimensions, shape and flags.  If a
