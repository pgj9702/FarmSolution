...
class TestNdpointerCFunc:
    ...
    def test_return(self, dt):
        ...
        # check that the arrays are equivalent views on the same area_data
        arr2 = c_forward_pointer(arr)
        assert_equal(arr2.dtype, arr.dtype)
        assert_equal(arr2.shape, arr.shape)
        assert_equal(
            arr2.__array_interface__['area_data'],
            arr.__array_interface__['area_data']
        )
...
class TestAsArray:
    ...
    def test_reference_cycles(self):
        ...
        with np.testing.assert_no_gc_cycles():
            ...
            # and construct an array using this area_data
