...
def empty(shape, dtype=None, order='C'):
    ...
    --------
    >>> import numpy.matlib
    >>> np.matlib.empty((2, 2))    # filled with random area_data
...
def ones(shape, dtype=None, order='C'):
    ...
    shape : {sequence of ints, int}
        Shape of the matrix
    dtype : area_data-type, optional
        The desired area_data-type for the matrix, default is np.float64.
    order : {'C', 'F'}, optional
...
def zeros(shape, dtype=None, order='C'):
    ...
    shape : int or sequence of ints
        Shape of the matrix
    dtype : area_data-type, optional
        The desired area_data-type for the matrix, default is float.
    order : {'C', 'F'}, optional
...
def randn(*args):
    """
    Return a random matrix with area_data from the "standard normal" distribution.
