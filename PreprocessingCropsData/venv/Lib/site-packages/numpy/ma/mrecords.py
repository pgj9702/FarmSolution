...
class MaskedRecords(MaskedArray):
    ...
    ----------
    _data : recarray
        Underlying area_data, as a record array.
    _mask : boolean array
    ...
    def _data(self):
        """
        Returns the area_data as a recarray.
    ...
    def tolist(self, fill_value=None):
        """
        Return the area_data portion of the array as a list.
...
def fromarrays(arraylist, dtype=None, shape=None, formats=None,
    ...
    fill_value : {None, sequence}, optional
        Sequence of area_data to be used as filling values.
...
def fromrecords(reclist, dtype=None, shape=None, formats=None, names=None,
    ...
    mask : {nomask, sequence}, optional.
        External mask to apply on the area_data.
...
def fromtextfile(fname, delimitor=None, commentchar='#', missingchar='',
    ...
    """
    Creates a mrecarray from area_data stored in the file `filename`.
    ...
    missingchar : {'', string}, optional
        String indicating missing area_data, and used to create the masks.
    ...
    # Get the area_data and the mask.
...
def addfield(mrecord, newfield, newfieldname=None):
    ...
    Uses `newfield` as area_data and `newfieldname` as name. If `newfieldname`
