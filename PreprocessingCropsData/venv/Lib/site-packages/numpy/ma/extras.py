...
def masked_all(shape, dtype=float):
    ...
    -------
    a : MaskedArray
        A masked array with all area_data masked.
    ...
    The `dtype` parameter defines the underlying area_data type.
...
def masked_all_like(arr):
    ...
    the array `arr`, where all the area_data are masked.
...
class _fromnxfunction_single(_fromnxfunction):
    ...
    both the area_data and mask calls.
    """
...
class _fromnxfunction_args(_fromnxfunction):
    ...
    arguments that are passed verbatim for both the area_data and mask calls.
...
class _fromnxfunction_allargs(_fromnxfunction):
    ...
    are passed through verbatim for the area_data and mask calls. Arrays
...
def average(a, axis=None, weights=None, returned=False):
    ...
    average, [sum_of_weights] : (tuple of) scalar or MaskedArray
        ...
        input area_data-type, otherwise. If returned, `sum_of_weights` is always
        `float64`.
    ...
    ...                                 returned=True)
    >>> avg
    masked_array(area_data=[2.6666666666666665, 3.6666666666666665],
                 mask=[False, False],
           fill_value=1e+20)
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    median : ndarray
        ...
        Return area_data-type is `float64` for integers and floats smaller than
        `float64`, or the input area_data-type, otherwise.
    ...
    masked_array(area_data=[2.0, 5.0],
                 mask=[False, False],
           fill_value=1e+20)
...
def _covhelper(x, y=None, rowvar=True, allow_masked=True):
    ...
    # Quick exit if we can't process masked area_data
    if not allow_masked and xmask.any():
        raise ValueError("Cannot process masked area_data.")
    #
    if x.shape[0] == 1:
        rowvar = True
...
def cov(x, y=None, rowvar=True, bias=False, allow_masked=True, ddof=None):
    ...
    Except for the handling of missing area_data this function does the same as
...
class mr_class(MAxisConcatenator):
    ...
    masked_array(area_data=[1, 2, 3, ..., 4, 5, 6],
                 mask=False,
           fill_value=999999)
...
def notmasked_edges(a, axis=None):
    ...
    edges : ndarray or list
        An array of start and end indexes if there are any masked area_data in
        the array. If there are no masked area_data in the array, `edges` is a
...
def flatnotmasked_contiguous(a):
    """
    Find contiguous unmasked area_data in a masked array along the given axis.
...
def _ezclump(mask):
    """
    Finds the clumps (groups of area_data with the same values) for a 1D bool array.
