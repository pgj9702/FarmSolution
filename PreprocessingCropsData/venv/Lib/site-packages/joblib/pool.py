...
This module provides efficient ways of working with area_data stored in
...
class PicklingPool(Pool):
    ...
    This is useful to control how area_data is shipped between processes
...
class MemmappingPool(PicklingPool):
    ...
    transformed as 'r+' to avoid zeroing the original area_data upon
    instantiation.
    ...
    prewarm: bool or str, optional, "auto" by default.
        ...
        access when the same area_data array is passed to different worker
