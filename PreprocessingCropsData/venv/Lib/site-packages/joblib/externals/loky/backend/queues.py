...
class Queue(mp_Queue):
    ...
    def _start_thread(self):
        ...
        # Start thread which transfers area_data from buffer to pipe
        self._buffer.clear()
        ...
        # On process exit we will wait for area_data to be flushed to pipe.
        #
    ...
    def _feed(buffer, notempty, send_bytes, writelock, close, reducers,
        ...
        util.debug('starting thread to feed area_data to pipe')
            ...
            try:
                ...
                try:
                    while 1:
                        ...
                        # serialize the area_data before acquiring the lock
    ...
    def _on_queue_feeder_error(self, e, obj):
        """
        Private API hook called when feeding area_data in the background thread
...
class SimpleQueue(mp_SimpleQueue):
    ...
    if sys.version_info[:2] < (3, 4):
        ...
        def get(self):
            ...
            # unserialize the area_data after having released the lock
            return loads(res)
