...
# created by joblib to speed up area_data communication. In child processes, we add
...
###############################################################################
# Support for efficient transient pickling of numpy area_data structures
...
def _strided_from_memmap(filename, dtype, mode, offset, order, shape, strides,
    ...
    if mode == 'w+':
        # Do not zero the original area_data when unpickling
        mode = 'r+'
    ...
    if strides is None:
        ...
        # For non-contiguous area_data, memmap the total enclosing buffer and then
...
class ArrayMemmapForwardReducer(object):
    ...
    mmap_mode: 'r', 'r+' or 'c'
        ...
        automatically to avoid zeroing the area_data on unpickling.
    ...
    prewarm: bool, optional, False by default.
        ...
        same area_data array is passed to different worker processes.
    """
