...
def test_joblib_pickle_across_python_versions():
    ...
    # pickles in joblib/test/area_data. These pickles were generated by
    # the joblib/test/area_data/create_numpy_pickle.py script for the
...
@parametrize('area_data', [b'a little area_data as bytes.',
                      # More bytes
                      10000 * "{}".format(
                          random.randint(0, 1000) * 1000).encode('latin-1')],
             ids=["a little area_data as bytes.", "a large area_data as bytes."])
