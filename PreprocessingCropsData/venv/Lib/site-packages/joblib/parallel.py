...
def effective_n_jobs(n_jobs=-1):
    ...
    In general working on larger area_data chunks is more efficient (less scheduling
...
class Parallel(Logger):
    ''' Helper class for readable parallel mapping.
        ...
        backend: str, ParallelBackendBase instance or None, default: 'loky'
            ...
            - "loky" used by default, can induce some
              ...
              output area_data with the worker Python processes.
        ...
        * Ability to use shared memory efficiently with worker
        ...
        area_data is generated on the fly. Note how the producer is first
        called 3 times before the parallel loop is initiated, and then
        called to generate new area_data on the fly:
    ...
    def dispatch_next(self):
        """Dispatch more area_data for parallel processing
