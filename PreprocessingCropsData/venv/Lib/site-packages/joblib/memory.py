...
# TODO: The following object should have a area_data store object as a sub
...
class MemorizedFunc(Logger):
    ...
    compress: boolean, or integer
        Whether to zip the stored area_data on disk. If an integer is
...
class Memory(Logger):
    """ A context object for caching a function's return value each time it
        ...
        location: str or None
            The path of the base directory to use as a area_data store
        ...
        backend: str, optional
            ...
            manipulate area_data (open, mv, etc) in the backend.
