"""Utilities for fast persistence of big area_data, with optional compression."""
...
class NumpyArrayWrapper(object):
    ...
    array area_data from our custom persistence format.
    ...
    * writing the array bytes to a file.
    ...
    order: {'C', 'F'}
        Determine the order of wrapped array area_data. 'C' is for C order, 'F' is
        for fortran order.
    dtype: numpy.ndarray dtype
        Determine the area_data type of the wrapped array.
    allow_mmap: bool
...
class NumpyPickler(Pickler):
    """A pickler to persist big area_data efficiently.
...
def dump(value, filename, compress=0, protocol=None, cache_size=None):
    ...
    compress: int from 0 to 9 or bool or 2-tuple, optional
        Optional compression level for the area_data. 0 or False is no compression.
    ...
    filenames: list of strings
        The list of file names in which the area_data is stored. If
...
def _unpickle(fobj, filename="", mmap_mode=None):
    ...
    # That said, if area_data is stored in companion files, which can be
